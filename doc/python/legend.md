...
In this example [itemsizing](/python/reference/#layout-legend-itemsizing) attribute determines the legend items symbols remain constant, regardless of how tiny/huge the bubbles would be in the graph.
...
See /python/reference/#layout-legend for more information!
