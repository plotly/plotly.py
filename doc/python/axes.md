...
This tutorial explain how to set the properties of [2-dimensional Cartesian axes](/examples/figure-structure.md#2d-cartesian-trace-types-and-subplots), namely [`go.layout.XAxis`](/reference/plotly/graph_objects/layout/_xaxis.md) and [`go.layout.YAxis`](/reference/plotly/graph_objects/layout/_yaxis.md).
