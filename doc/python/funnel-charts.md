...
This example uses [textposition](/python/reference/#scatter-textposition) and [textinfo](/python/reference/#funnel-textinfo) to determine information apears on the graph, and shows how to customize the bars.
...
See /python/reference/#funnel and /python/reference/#funnelarea for more information and chart attribute options!
