...
This example uses the [waterfallgroupgap attribute](/python/reference/#layout-waterfallgroupgap), which sets a gap between bars.
...
This example uses [decreasing, increasing, and total](/python/reference/#waterfall-increasing) attributes to customize the bars.
...
#### Reference
See /python/reference/#waterfall for more information and chart attribute options!
