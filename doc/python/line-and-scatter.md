...
**Try it yourself!** Use the following interactive scatter plot app, hosted on [Plotly Cloud](https://plotly.com/cloud/), to see how the code updates based on your selections.
