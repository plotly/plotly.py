...
To customize the tooltip on your graph you can use [hovertemplate](/python/reference/#pie-hovertemplate), which is a template string used for rendering the information that appear on hoverbox.
...
Hovertemplate customize the tooltip text vs. [texttemplate](/python/reference/#pie-texttemplate) which customizes the text that appears on your chart. <br>
Set the horizontal alignment of the text within tooltip with [hoverlabel.align](/python/reference/#layout-hoverlabel-align).
...
The following example shows how to format hover template. [Here](/python/v3/hover-text-and-formatting/#dash-example) is an example to see how to format hovertemplate in Dash.
