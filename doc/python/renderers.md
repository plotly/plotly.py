...
A set of renderers is provided for displaying figures as static images.  These renderers all rely on the orca static image export utility. See the [Static Image Export](/python/static-image-export/) page for more information on getting set up with orca.
