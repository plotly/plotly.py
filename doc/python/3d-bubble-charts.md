...
fig = go.Figure(data=go.Scatter3d(
    ...
    marker = dict(
        sizemode = 'diameter',
        sizeref = 750, # info on sizeref: /python/reference/#scatter-marker-sizeref
...
See /python/reference/#scatter3d and /python/reference/#scatter-marker-sizeref <br>for more information and chart attribute options!
