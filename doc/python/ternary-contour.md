...
For ternary contour plots, use the [figure factory](../figure-factories/) called ``create_ternary_contour``. The figure factory interpolates between given data points in order to compute the contours.
