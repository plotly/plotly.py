...
#### Reference
All of the y-axis properties are found here: /python/reference/#YAxis.  For more information on creating subplots see the [Subplots in Python](/python/subplots/) section.
