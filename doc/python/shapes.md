...
There are two ways to draw filled shapes: scatter traces and [layout.shapes](/python/reference/#layout-shapes-items-shape-type) which is mostly useful for the 2d subplots, and defines the shape type to be drawn, and can be rectangle, circle, line, or path (a custom SVG path). You also can use [scatterpolar](/python/polar-chart/#categorical-polar-chart), scattergeo, [scattermapbox](/python/filled-area-on-mapbox/#filled-scattermapbox-trace) to draw filled shapes on any kind of subplots. To set an area to be filled with a solid color, you need to define [Scatter.fill="toself"](/python/reference/#scatter-fill) that connects the endpoints of the trace into a closed shape. If `mode=line` (default value), then you need to repeat the initial point of a shape at the of the sequence to have a closed shape. 
...
You can have more shapes either by adding [more traces](/python/filled-area-plots/) or interrupting the series with `None`.
...
### Reference
See /python/reference/#layout-shapes for more information and chart attribute options!
