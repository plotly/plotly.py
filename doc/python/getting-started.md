...
3. You can check out our exhaustive **reference** guides: the [Python API reference](python-api-reference.md) or the [Figure Reference](/reference/graph_objects/index.md).
