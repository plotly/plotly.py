...
jupyter:
  ...
  language_info:
    ...
    version: 3.10.0
  plotly:
    description: How to make scatter plots on Map maps in Python.
    display_as: maps
    language: python
    layout: base
    name: Scatter Plots on Map
    order: 9
    page_type: u-guide
    permalink: python/scattermap/
...
You can define a symbol on your map by setting [symbol](https://plotly.com/python/reference/scattermap/#scattermap-marker-symbol) attribute. This attribute only works on Map-provided `style`s:
...
See [function reference for `px.(scatter_map)`](https://plotly.com/python-api-reference/generated/plotly.express.scatter_map) or https://plotly.com/python/reference/scattermap/ for more information and options!
