...
Several representations of statistical distributions are available in plotly, such as [histograms](/python/histograms/), [violin plots](/python/violin/), [box plots](/python/box-plots/) (see [the complete list here](/python/statistical-charts/)). It is also possible to combine several representations in the same plot.
