...
You can define a symbol on your map by setting [symbol](/python/reference/#scattermapbox-marker-symbol) attribute. This attribute only works on Mapbox-provided `style`s:
...
See /python/reference/#scattermapbox for more information and options!
