...
custom_validator_datatypes = {
    'layout.image.source': 'plotly.basevalidators.ImageUriValidator',
...
class PlotlyNode:
    ...
    def name_base_validator(self) -> str:
        if self.dir_str in custom_validator_datatypes:
            ...
            validator_base = f"plotly.basevalidators.{self.datatype_pascal_case}Validator"
    ...
    def validator_instance(self) -> BaseValidator:
        ...
        if validator_class == CompoundValidator:
            data_class_str = f"<class plotly.datatypes.{self.parent_dir_str}.{self.name_class}>"
            ...
            element_class_str = f"<class plotly.datatypes.{self.parent_dir_str}.{self.name_class}>"
