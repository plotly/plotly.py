...
class ShowscaleValidator(_plotly_utils.basevalidators.BooleanValidator):
    ...
    def __init__(
        self, plotly_name='showscale', parent_name='funnel.marker', **kwargs
    ):
...
class OpacitysrcValidator(_plotly_utils.basevalidators.SrcValidator):
    ...
    def __init__(
        self, plotly_name='opacitysrc', parent_name='funnel.marker', **kwargs
    ):
...
class OpacityValidator(_plotly_utils.basevalidators.NumberValidator):
    ...
    def __init__(
        self, plotly_name='opacity', parent_name='funnel.marker', **kwargs
    ):
...
class LineValidator(_plotly_utils.basevalidators.CompoundValidator):
    ...
    def __init__(
        self, plotly_name='line', parent_name='funnel.marker', **kwargs
    ):
...
class ColorsrcValidator(_plotly_utils.basevalidators.SrcValidator):
    ...
    def __init__(
        self, plotly_name='colorsrc', parent_name='funnel.marker', **kwargs
    ):
...
class ColorscaleValidator(_plotly_utils.basevalidators.ColorscaleValidator):
    ...
    def __init__(
        self, plotly_name='colorscale', parent_name='funnel.marker', **kwargs
    ):
...
class ColorBarValidator(_plotly_utils.basevalidators.CompoundValidator):
    ...
    def __init__(
        self, plotly_name='colorbar', parent_name='funnel.marker', **kwargs
    ):
...
class ColoraxisValidator(_plotly_utils.basevalidators.SubplotidValidator):
    ...
    def __init__(
        self, plotly_name='coloraxis', parent_name='funnel.marker', **kwargs
    ):
...
class ColorValidator(_plotly_utils.basevalidators.ColorValidator):
    ...
    def __init__(
        self, plotly_name='color', parent_name='funnel.marker', **kwargs
    ):
...
class CminValidator(_plotly_utils.basevalidators.NumberValidator):
    ...
    def __init__(
        self, plotly_name='cmin', parent_name='funnel.marker', **kwargs
    ):
...
class CmidValidator(_plotly_utils.basevalidators.NumberValidator):
    ...
    def __init__(
        self, plotly_name='cmid', parent_name='funnel.marker', **kwargs
    ):
...
class CmaxValidator(_plotly_utils.basevalidators.NumberValidator):
    ...
    def __init__(
        self, plotly_name='cmax', parent_name='funnel.marker', **kwargs
    ):
...
class CautoValidator(_plotly_utils.basevalidators.BooleanValidator):
    ...
    def __init__(
        self, plotly_name='cauto', parent_name='funnel.marker', **kwargs
    ):
