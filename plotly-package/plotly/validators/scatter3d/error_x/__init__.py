...
class WidthValidator(_plotly_utils.basevalidators.NumberValidator):
    ...
    def __init__(
        self, plotly_name='width', parent_name='scatter3d.error_x', **kwargs
    ):
...
class TypeValidator(_plotly_utils.basevalidators.EnumeratedValidator):
    ...
    def __init__(
        self, plotly_name='type', parent_name='scatter3d.error_x', **kwargs
    ):
...
class ColorValidator(_plotly_utils.basevalidators.ColorValidator):
    ...
    def __init__(
        self, plotly_name='color', parent_name='scatter3d.error_x', **kwargs
    ):
...
class ArrayValidator(_plotly_utils.basevalidators.DataArrayValidator):
    ...
    def __init__(
        self, plotly_name='array', parent_name='scatter3d.error_x', **kwargs
    ):
