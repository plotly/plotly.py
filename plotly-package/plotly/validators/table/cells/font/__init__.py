...
class SizesrcValidator(_plotly_utils.basevalidators.SrcValidator):
    ...
    def __init__(
        self, plotly_name='sizesrc', parent_name='table.cells.font', **kwargs
    ):
...
class SizeValidator(_plotly_utils.basevalidators.NumberValidator):
    ...
    def __init__(
        self, plotly_name='size', parent_name='table.cells.font', **kwargs
    ):
...
class FamilyValidator(_plotly_utils.basevalidators.StringValidator):
    ...
    def __init__(
        self, plotly_name='family', parent_name='table.cells.font', **kwargs
    ):
...
class ColorValidator(_plotly_utils.basevalidators.ColorValidator):
    ...
    def __init__(
        self, plotly_name='color', parent_name='table.cells.font', **kwargs
    ):
