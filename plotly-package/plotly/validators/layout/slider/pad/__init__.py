...
class TValidator(_plotly_utils.basevalidators.NumberValidator):
    ...
    def __init__(
        self, plotly_name='t', parent_name='layout.slider.pad', **kwargs
    ):
...
class RValidator(_plotly_utils.basevalidators.NumberValidator):
    ...
    def __init__(
        self, plotly_name='r', parent_name='layout.slider.pad', **kwargs
    ):
...
class LValidator(_plotly_utils.basevalidators.NumberValidator):
    ...
    def __init__(
        self, plotly_name='l', parent_name='layout.slider.pad', **kwargs
    ):
...
class BValidator(_plotly_utils.basevalidators.NumberValidator):
    ...
    def __init__(
        self, plotly_name='b', parent_name='layout.slider.pad', **kwargs
    ):
