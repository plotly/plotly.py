...
class XValidator(_plotly_utils.basevalidators.InfoArrayValidator):
    ...
    def __init__(
        self, plotly_name='x', parent_name='layout.geo.domain', **kwargs
    ):
...
class RowValidator(_plotly_utils.basevalidators.IntegerValidator):
    ...
    def __init__(
        self, plotly_name='row', parent_name='layout.geo.domain', **kwargs
    ):
...
class ColumnValidator(_plotly_utils.basevalidators.IntegerValidator):
    ...
    def __init__(
        self, plotly_name='column', parent_name='layout.geo.domain', **kwargs
    ):
