...
class FontValidator(_plotly_utils.basevalidators.CompoundValidator):
    ...
    def __init__(
        self, plotly_name='font', parent_name='area.hoverlabel', **kwargs
    ):
...
class BgcolorValidator(_plotly_utils.basevalidators.ColorValidator):
    ...
    def __init__(
        self, plotly_name='bgcolor', parent_name='area.hoverlabel', **kwargs
    ):
...
class AlignsrcValidator(_plotly_utils.basevalidators.SrcValidator):
    ...
    def __init__(
        self, plotly_name='alignsrc', parent_name='area.hoverlabel', **kwargs
    ):
...
class AlignValidator(_plotly_utils.basevalidators.EnumeratedValidator):
    ...
    def __init__(
        self, plotly_name='align', parent_name='area.hoverlabel', **kwargs
    ):
