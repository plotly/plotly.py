...
class YbingroupValidator(_plotly_utils.basevalidators.StringValidator):
    ...
    def __init__(
        self, plotly_name='ybingroup', parent_name='histogram2d', **kwargs
    ):
...
class XbingroupValidator(_plotly_utils.basevalidators.StringValidator):
    ...
    def __init__(
        self, plotly_name='xbingroup', parent_name='histogram2d', **kwargs
    ):
...
class MetasrcValidator(_plotly_utils.basevalidators.SrcValidator):
    ...
    def __init__(
        self, plotly_name='metasrc', parent_name='histogram2d', **kwargs
    ):
...
class MetaValidator(_plotly_utils.basevalidators.AnyValidator):
    ...
    def __init__(
        self, plotly_name='meta', parent_name='histogram2d', **kwargs
    ):
...
class ColoraxisValidator(_plotly_utils.basevalidators.SubplotidValidator):
    ...
    def __init__(
        self, plotly_name='coloraxis', parent_name='histogram2d', **kwargs
    ):
...
class BingroupValidator(_plotly_utils.basevalidators.StringValidator):
    ...
    def __init__(
        self, plotly_name='bingroup', parent_name='histogram2d', **kwargs
    ):
