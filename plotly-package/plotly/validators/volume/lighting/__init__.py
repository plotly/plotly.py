...
class SpecularValidator(_plotly_utils.basevalidators.NumberValidator):
    ...
    def __init__(
        self, plotly_name='specular', parent_name='volume.lighting', **kwargs
    ):
...
class FresnelValidator(_plotly_utils.basevalidators.NumberValidator):
    ...
    def __init__(
        self, plotly_name='fresnel', parent_name='volume.lighting', **kwargs
    ):
...
class DiffuseValidator(_plotly_utils.basevalidators.NumberValidator):
    ...
    def __init__(
        self, plotly_name='diffuse', parent_name='volume.lighting', **kwargs
    ):
...
class AmbientValidator(_plotly_utils.basevalidators.NumberValidator):
    ...
    def __init__(
        self, plotly_name='ambient', parent_name='volume.lighting', **kwargs
    ):
