...
import chartstudio.tools as tls
import plotly.tools
from chartstudio import session
from chartstudio.tests.utils import PlotlyTestCase
from chartstudio.plotly import plotly as py
from _plotly_utils.exceptions import PlotlyError, PlotlyEmptyDataError
from chartstudio.files import CONFIG_FILE
...
class TestPlotOptionLogic(PlotlyTestCase):
    ...
    def setUp(self):
        ...
        patcher = patch('chartstudio.api.v2.users.current')
