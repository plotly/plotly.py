...
from chartstudio.api.utils import to_native_utf8_string
from chartstudio.api.v1 import utils
from chartstudio.exceptions import PlotlyRequestError
from _plotly_utils.exceptions import PlotlyError
from chartstudio.session import sign_in
from chartstudio.tests.test_plot_ly.test_api import PlotlyApiTestCase
from chartstudio.tests.utils import PlotlyTestCase
...
class RequestTest(PlotlyTestCase):
    ...
    def setUp(self):
        ...
        patcher = patch('chartstudio.api.v1.utils.requests.request')
        ...
        patcher = patch('chartstudio.api.v1.utils.validate_response')
