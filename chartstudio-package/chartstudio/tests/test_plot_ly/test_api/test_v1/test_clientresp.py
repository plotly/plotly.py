...
from chartstudio.api.v1 import clientresp
...
class ClientrespTest(PlotlyApiTestCase):
    ...
    def setUp(self):
        ...
        self.request_mock = self.mock('chartstudio.api.v1.utils.requests.request')
        self.request_mock.return_value = self.get_response(b'{}', 200)

        # Mock the validation function since we can test that elsewhere.
        self.mock('chartstudio.api.v1.utils.validate_response')
