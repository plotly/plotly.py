...
import chartstudio
import chartstudio.presentation_objs as pres
...
class TestPresentation(TestCase):
    ...
    def test_invalid_style(self):
        ...
        self.assertRaisesRegexp(
            PlotlyError, chartstudio.presentation_objs.presentation_objs.STYLE_ERROR,
    ...
    def test_open_code_block(self):
        ...
        self.assertRaisesRegexp(
            PlotlyError, chartstudio.presentation_objs.presentation_objs.CODE_ENV_ERROR,
    ...
    def test_invalid_code_language(self):
        ...
        self.assertRaisesRegexp(
            PlotlyError, chartstudio.presentation_objs.presentation_objs.LANG_ERROR, pres.Presentation,
