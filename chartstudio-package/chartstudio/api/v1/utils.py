...
from chartstudio import config, exceptions
from chartstudio.api.utils import basic_auth
from chartstudio.api.v2.utils import should_retry
...
def request(method, url, **kwargs):
    ...
    if kwargs.get('json', None) is not None:
        # See chartstudio.api.v2.utils.request for examples on how to do this.
