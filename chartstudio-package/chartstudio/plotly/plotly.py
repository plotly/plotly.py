...
from chartstudio import files, session, tools, utils, exceptions
from chartstudio.api import v1, v2
from chartstudio.plotly import chunked_requests
from chartstudio.grid_objs import Grid
from chartstudio.dashboard_objs import dashboard_objs as dashboard

# This is imported like this for backwards compat. Careful if changing.
from chartstudio.config import get_config, get_credentials
...
def _extract_grid_graph_obj(obj_dict, reference_obj, grid, path):
    ...
    from chartstudio.grid_objs import Column
