...
class Tickformatstops(_BaseTraceHierarchyType):
    ...
    _path_str = "scattergeo.marker.colorbar.tickformatstops"
    _valid_props = {""}
    ...
    def __init__(self, arg=None, **kwargs):
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the plotly.graph_objs.scattergeo.marker.colorbar.Tickformatstops 
