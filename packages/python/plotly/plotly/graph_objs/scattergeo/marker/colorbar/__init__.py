...
an instance of :py:class:`plotly.graph_objs.scattergeo.marker.colorbar.Title`"""
            )
...
constructor must be a dict or 
an instance of :py:class:`plotly.graph_objs.scattergeo.marker.colorbar.Tickformatstop`"""
            )
...
constructor must be a dict or 
an instance of :py:class:`plotly.graph_objs.scattergeo.marker.colorbar.Tickfont`"""
            )
