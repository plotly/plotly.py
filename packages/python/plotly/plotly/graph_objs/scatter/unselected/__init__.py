...
class Textfont(_BaseTraceHierarchyType):
    ...
    def __init__(self, arg=None, color=None, **kwargs):
        ...
        arg
            ...
            an instance of :py:class:`plotly.graph_objs.scatter.uns
            elected.Textfont`
        color
            Sets the text font color of unselected points, applied
            only when a selection exists.
...
an instance of :py:class:`plotly.graph_objs.scatter.unselected.Textfont`"""
            )
...
class Marker(_BaseTraceHierarchyType):
    ...
    def __init__(self, arg=None, color=None, opacity=None, size=None, **kwargs):
        ...
        arg
            dict of properties compatible with this constructor or
            an instance of
            :py:class:`plotly.graph_objs.scatter.unselected.Marker`
        color
            Sets the marker color of unselected points, applied
            only when a selection exists.
        opacity
...
constructor must be a dict or 
an instance of :py:class:`plotly.graph_objs.scatter.unselected.Marker`"""
            )
