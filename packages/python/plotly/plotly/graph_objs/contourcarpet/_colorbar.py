...
class ColorBar(_BaseTraceHierarchyType):
    ...
    def tickformatstops(self):
        ...
        that may be specified as:
          - An instance of :class:`plotly.graph_objs.contourcarpet.colorbar.Tickformatstops`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        plotly.graph_objs.contourcarpet.colorbar.Tickformatstops
        """
    ...
    def _prop_descriptions(self):
        ...
        tickformat
            ...
            tickformat "%H~%M~%S.%2f" would display "09~15~23.46"
        tickformatstops
            :class:`plotly.graph_objects.contourcarpet.colorbar.Tic
            kformatstops` instance or dict with compatible
            properties
        ticklabelposition
            Determines where tick labels are drawn.
        ticklen
