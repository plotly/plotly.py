...
class Z(_BaseTraceHierarchyType):
    ...
    def __init__(self, arg=None, opacity=None, scale=None, show=None, **kwargs):
        ...
        arg
            ...
            an instance of
            :py:class:`plotly.graph_objs.scatter3d.projection.Z`
        opacity
            Sets the projection color.
        scale
            Sets the scale factor determining the size of the
...
an instance of :py:class:`plotly.graph_objs.scatter3d.projection.Z`"""
            )
...
class Y(_BaseTraceHierarchyType):
    ...
    def __init__(self, arg=None, opacity=None, scale=None, show=None, **kwargs):
        ...
        arg
            dict of properties compatible with this constructor or
            an instance of
            :py:class:`plotly.graph_objs.scatter3d.projection.Y`
        opacity
            Sets the projection color.
        scale
            Sets the scale factor determining the size of the
...
constructor must be a dict or 
an instance of :py:class:`plotly.graph_objs.scatter3d.projection.Y`"""
            )
...
class X(_BaseTraceHierarchyType):
    ...
    def __init__(self, arg=None, opacity=None, scale=None, show=None, **kwargs):
        ...
        arg
            dict of properties compatible with this constructor or
            an instance of
            :py:class:`plotly.graph_objs.scatter3d.projection.X`
        opacity
            Sets the projection color.
        scale
            Sets the scale factor determining the size of the
...
constructor must be a dict or 
an instance of :py:class:`plotly.graph_objs.scatter3d.projection.X`"""
            )
