...
class Title(_BaseTraceHierarchyType):
    ...
    def __init__(self, arg=None, font=None, side=None, text=None, **kwargs):
        ...
        arg
            ...
            an instance of
            :py:class:`plotly.graph_objs.isosurface.colorbar.Title`
        font
            Sets this color bar's title font. Note that the title's
            font used to be set by the now deprecated `titlefont`
            attribute.
...
an instance of :py:class:`plotly.graph_objs.isosurface.colorbar.Title`"""
            )
...
constructor must be a dict or 
an instance of :py:class:`plotly.graph_objs.isosurface.colorbar.Tickformatstop`"""
            )
...
constructor must be a dict or 
an instance of :py:class:`plotly.graph_objs.isosurface.colorbar.Tickfont`"""
            )
