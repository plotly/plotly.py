...
class Textfont(_BaseTraceHierarchyType):
    ...
    def __init__(self, arg=None, color=None, **kwargs):
        ...
        arg
            ...
            an instance of :py:class:`plotly.graph_objs.histogram.u
            nselected.Textfont`
        color
            Sets the text font color of unselected points, applied
            only when a selection exists.
...
an instance of :py:class:`plotly.graph_objs.histogram.unselected.Textfont`"""
            )
...
constructor must be a dict or 
an instance of :py:class:`plotly.graph_objs.histogram.unselected.Marker`"""
            )
