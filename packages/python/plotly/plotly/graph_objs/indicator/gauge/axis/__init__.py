    ...
    def __init__(
        ...
        **kwargs
        ...
        arg
            ...
            an instance of :py:class:`plotly.graph_objs.indicator.g
...
an instance of :py:class:`plotly.graph_objs.indicator.gauge.axis.Tickformatstop`"""
            )
...
constructor must be a dict or 
an instance of :py:class:`plotly.graph_objs.indicator.gauge.axis.Tickfont`"""
            )
