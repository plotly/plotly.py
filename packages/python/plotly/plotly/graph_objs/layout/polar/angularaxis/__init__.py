...
an instance of :py:class:`plotly.graph_objs.layout.polar.angularaxis.Tickformatstop`"""
            )
...
constructor must be a dict or 
an instance of :py:class:`plotly.graph_objs.layout.polar.angularaxis.Tickfont`"""
            )
