...
class AngularAxis(_BaseLayoutHierarchyType):
    ...
    def tickformatstops(self):
        ...
        Returns
        -------
        plotly.graph_objs.layout.polar.angularaxis.Tickformatstops
        """
    ...
    def _prop_descriptions(self):
        ...
        tickformat
            ...
            tickformat "%H~%M~%S.%2f" would display "09~15~23.46"
        tickformatstops
            :class:`plotly.graph_objects.layout.polar.angularaxis.T
            ickformatstops` instance or dict with compatible
            properties
        ticklen
            Sets the tick length (in px).
        tickmode
