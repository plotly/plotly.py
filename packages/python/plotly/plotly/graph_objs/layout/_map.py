...
class Map(_BaseLayoutHierarchyType):
    ...
    def style(self):
        ...
        street-map, outdoors, satellite, satellite-streets, stamen-
        terrain, stamen-toner, stamen-watercolor, streets, white-bg.
    ...
    def _prop_descriptions(self):
        ...
        style
            ...
            satellite, satellite-streets, stamen-terrain, stamen-
            toner, stamen-watercolor, streets, white-bg.
        uirevision
