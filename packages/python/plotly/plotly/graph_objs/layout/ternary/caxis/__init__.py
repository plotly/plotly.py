...
an instance of :py:class:`plotly.graph_objs.layout.ternary.caxis.Title`"""
            )
...
constructor must be a dict or 
an instance of :py:class:`plotly.graph_objs.layout.ternary.caxis.Tickformatstop`"""
            )
...
constructor must be a dict or 
an instance of :py:class:`plotly.graph_objs.layout.ternary.caxis.Tickfont`"""
            )
