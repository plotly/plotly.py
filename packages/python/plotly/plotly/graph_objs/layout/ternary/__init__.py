...
class Domain(_BaseLayoutHierarchyType):
    ...
    def __init__(self, arg=None, column=None, row=None, x=None, y=None, **kwargs):
        ...
        arg
            ...
            an instance of
            :py:class:`plotly.graph_objs.layout.ternary.Domain`
        column
            If there is a layout grid, use the domain for this
            column in the grid for this ternary subplot .
        row
...
an instance of :py:class:`plotly.graph_objs.layout.ternary.Domain`"""
            )
...
class Caxis(_BaseLayoutHierarchyType):
    ...
    def _prop_descriptions(self):
        ...
        tickformat
            ...
            display "09~15~23.46"
        tickformatstops
            A tuple of :py:class:`plotly.graph_objects.layout.terna
            ry.caxis.Tickformatstop` instances or dicts with
        ...
        tickwidth
            Sets the tick width (in px).
        title
            :py:class:`plotly.graph_objects.layout.ternary.caxis.Ti
    ...
    def __init__(
        ...
        **kwargs
        ...
        arg
            dict of properties compatible with this constructor or
            an instance of
            :py:class:`plotly.graph_objs.layout.ternary.Caxis`
        color
            Sets default for all colors associated with this axis
            all at once: line, font, tick, and grid colors. Grid
            color is lightened by blending this with the plot
...
constructor must be a dict or 
an instance of :py:class:`plotly.graph_objs.layout.ternary.Caxis`"""
            )
...
class Baxis(_BaseLayoutHierarchyType):
    ...
    def _prop_descriptions(self):
        ...
        tickformatstops
            A tuple of :py:class:`plotly.graph_objects.layout.terna
            ry.baxis.Tickformatstop` instances or dicts with
            compatible properties
        tickformatstopdefaults
            When used in a template (as layout.template.layout.tern
        ...
        tickwidth
            Sets the tick width (in px).
        title
            :py:class:`plotly.graph_objects.layout.ternary.baxis.Ti
            tle` instance or dict with compatible properties
        titlefont
    ...
    def __init__(
        ...
        **kwargs
        ...
        arg
            dict of properties compatible with this constructor or
            an instance of
            :py:class:`plotly.graph_objs.layout.ternary.Baxis`
        color
            Sets default for all colors associated with this axis
            all at once: line, font, tick, and grid colors. Grid
            color is lightened by blending this with the plot
...
constructor must be a dict or 
an instance of :py:class:`plotly.graph_objs.layout.ternary.Baxis`"""
            )
...
class Aaxis(_BaseLayoutHierarchyType):
    ...
    def _prop_descriptions(self):
        ...
        tickformatstops
            A tuple of :py:class:`plotly.graph_objects.layout.terna
            ry.aaxis.Tickformatstop` instances or dicts with
            compatible properties
        tickformatstopdefaults
            When used in a template (as layout.template.layout.tern
        ...
        tickwidth
            Sets the tick width (in px).
        title
            :py:class:`plotly.graph_objects.layout.ternary.aaxis.Ti
            tle` instance or dict with compatible properties
        titlefont
    ...
    def __init__(
        ...
        **kwargs
        ...
        arg
            dict of properties compatible with this constructor or
            an instance of
            :py:class:`plotly.graph_objs.layout.ternary.Aaxis`
        color
            Sets default for all colors associated with this axis
            all at once: line, font, tick, and grid colors. Grid
            color is lightened by blending this with the plot
...
constructor must be a dict or 
an instance of :py:class:`plotly.graph_objs.layout.ternary.Aaxis`"""
            )
