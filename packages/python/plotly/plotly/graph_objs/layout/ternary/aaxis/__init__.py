...
an instance of :py:class:`plotly.graph_objs.layout.ternary.aaxis.Title`"""
            )
...
constructor must be a dict or 
an instance of :py:class:`plotly.graph_objs.layout.ternary.aaxis.Tickformatstop`"""
            )
...
constructor must be a dict or 
an instance of :py:class:`plotly.graph_objs.layout.ternary.aaxis.Tickfont`"""
            )
