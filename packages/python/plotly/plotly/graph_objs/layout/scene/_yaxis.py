...
class YAxis(_BaseLayoutHierarchyType):
    ...
    def tickformatstops(self):
        ...
        Returns
        -------
        plotly.graph_objs.layout.scene.yaxis.Tickformatstops
        """
    ...
    def _prop_descriptions(self):
        ...
        tickformat
            ...
            tickformat "%H~%M~%S.%2f" would display "09~15~23.46"
        tickformatstops
            :class:`plotly.graph_objects.layout.scene.yaxis.Tickfor
            matstops` instance or dict with compatible properties
        ticklen
            Sets the tick length (in px).
        tickmode
