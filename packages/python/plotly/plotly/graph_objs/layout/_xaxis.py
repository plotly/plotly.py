...
class XAxis(_BaseLayoutHierarchyType):
    ...
    def tickformatstops(self):
        ...
        that may be specified as:
          - An instance of :class:`plotly.graph_objs.layout.xaxis.Tickformatstops`
          - A dict of string/value properties that will be passed
        ...
        Returns
        -------
        plotly.graph_objs.layout.xaxis.Tickformatstops
        """
    ...
    def _prop_descriptions(self):
        ...
        range
            ...
            appears.
        rangebreaks
            :class:`plotly.graph_objects.layout.xaxis.Rangebreaks`
        ...
        tickformat
            ...
            tickformat "%H~%M~%S.%2f" would display "09~15~23.46"
        tickformatstops
            :class:`plotly.graph_objects.layout.xaxis.Tickformatsto
