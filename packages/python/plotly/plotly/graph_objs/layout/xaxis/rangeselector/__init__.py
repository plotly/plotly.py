...
an instance of :py:class:`plotly.graph_objs.layout.xaxis.rangeselector.Font`"""
            )
...
constructor must be a dict or 
an instance of :py:class:`plotly.graph_objs.layout.xaxis.rangeselector.Button`"""
            )
