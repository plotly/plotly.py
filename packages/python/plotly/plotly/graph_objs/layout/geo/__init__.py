...
class Projection(_BaseLayoutHierarchyType):
    ...
    def _prop_descriptions(self):
        ...
        rotation
            :py:class:`plotly.graph_objects.layout.geo.projection.R
            otation` instance or dict with compatible properties
        scale
    ...
    def __init__(
        ...
        arg
            ...
            an instance of
            :py:class:`plotly.graph_objs.layout.geo.Projection`
        parallels
            For conic projection types only. Sets the parallels
            (tangent, secant) where the cone intersects the sphere.
        rotation
...
an instance of :py:class:`plotly.graph_objs.layout.geo.Projection`"""
            )
    ...
    def __init__(
        ...
        **kwargs
        ...
        arg
            dict of properties compatible with this constructor or
            an instance of
            :py:class:`plotly.graph_objs.layout.geo.Lonaxis`
        dtick
            Sets the graticule's longitude/latitude tick step.
        gridcolor
            Sets the graticule's stroke color.
...
constructor must be a dict or 
an instance of :py:class:`plotly.graph_objs.layout.geo.Lonaxis`"""
            )
    ...
    def __init__(
        ...
        **kwargs
        ...
        arg
            dict of properties compatible with this constructor or
            an instance of
            :py:class:`plotly.graph_objs.layout.geo.Lataxis`
        dtick
            Sets the graticule's longitude/latitude tick step.
        gridcolor
            Sets the graticule's stroke color.
...
constructor must be a dict or 
an instance of :py:class:`plotly.graph_objs.layout.geo.Lataxis`"""
            )
...
class Domain(_BaseLayoutHierarchyType):
    ...
    def __init__(self, arg=None, column=None, row=None, x=None, y=None, **kwargs):
        ...
        arg
            dict of properties compatible with this constructor or
            an instance of
            :py:class:`plotly.graph_objs.layout.geo.Domain`
        column
            If there is a layout grid, use the domain for this
            column in the grid for this geo subplot . Note that geo
            subplots are constrained by domain. In general, when
...
constructor must be a dict or 
an instance of :py:class:`plotly.graph_objs.layout.geo.Domain`"""
            )
...
class Center(_BaseLayoutHierarchyType):
    ...
    def __init__(self, arg=None, lat=None, lon=None, **kwargs):
        ...
        arg
            dict of properties compatible with this constructor or
            an instance of
            :py:class:`plotly.graph_objs.layout.geo.Center`
        lat
            Sets the latitude of the map's center. For all
            projection types, the map's latitude center lies at the
            middle of the latitude range by default.
...
constructor must be a dict or 
an instance of :py:class:`plotly.graph_objs.layout.geo.Center`"""
            )
