...
class Shape(_BaseLayoutHierarchyType):
    ...
    def xref(self):
        """
        Sets the shape's x coordinate axis. If set to a  x  axis id
        (e.g. * x * or * x 2*), the ` x ` position refers to a  x
        ...
        of the second  x  axis. If the axis `type` is "log", then you
