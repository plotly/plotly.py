...
an instance of :py:class:`plotly.graph_objs.histogram2d.colorbar.Title`"""
            )
...
constructor must be a dict or 
an instance of :py:class:`plotly.graph_objs.histogram2d.colorbar.Tickformatstop`"""
            )
...
constructor must be a dict or 
an instance of :py:class:`plotly.graph_objs.histogram2d.colorbar.Tickfont`"""
            )
