    ...
    def __init__(
        ...
        **kwargs
        ...
        arg
            ...
            an instance of
            :py:class:`plotly.graph_objs.bar.marker.Line`
        autocolorscale
            Determines whether the colorscale is a default palette
            (`autocolorscale: true`) or the palette determined by
            `marker.line.colorscale`. Has an effect only if in
...
an instance of :py:class:`plotly.graph_objs.bar.marker.Line`"""
            )
...
class ColorBar(_BaseTraceHierarchyType):
    ...
    def tickfont(self):
        ...
        that may be specified as:
          - An instance of :py:func:`plotly.graph_objs.bar.marker.colorbar.Tickfont`
    ...
    def tickformatstopdefaults(self):
        ...
        that may be specified as:
          - An instance of :py:func:`plotly.graph_objs.bar.marker.colorbar.Tickformatstop`
          - A dict of string/value properties that will be passed
    ...
    def title(self):
        ...
        that may be specified as:
          - An instance of :py:func:`plotly.graph_objs.bar.marker.colorbar.Title`
          - A dict of string/value properties that will be passed
    ...
    def titlefont(self):
        ...
        that may be specified as:
          - An instance of :py:func:`plotly.graph_objs.bar.marker.colorbar.title.Font`
          - A dict of string/value properties that will be passed
    ...
    def _prop_descriptions(self):
        ...
        tickformat
            ...
            display "09~15~23.46"
        tickformatstops
            A tuple of :py:class:`plotly.graph_objects.bar.marker.c
        ...
        tickwidth
            Sets the tick width (in px).
        title
            :py:class:`plotly.graph_objects.bar.marker.colorbar.Tit
    ...
    def __init__(
        ...
        **kwargs
        ...
        arg
            dict of properties compatible with this constructor or
            an instance of
            :py:class:`plotly.graph_objs.bar.marker.ColorBar`
        bgcolor
            Sets the color of padded area.
        bordercolor
            Sets the axis line color.
...
constructor must be a dict or 
an instance of :py:class:`plotly.graph_objs.bar.marker.ColorBar`"""
            )
