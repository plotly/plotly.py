...
an instance of :py:class:`plotly.graph_objs.scatterternary.unselected.Textfont`"""
            )
...
constructor must be a dict or 
an instance of :py:class:`plotly.graph_objs.scatterternary.unselected.Marker`"""
            )
