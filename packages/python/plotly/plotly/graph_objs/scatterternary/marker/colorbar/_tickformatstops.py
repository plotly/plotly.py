...
class Tickformatstops(_BaseTraceHierarchyType):
    ...
    _path_str = "scatterternary.marker.colorbar.tickformatstops"
    _valid_props = {""}
    ...
    def __init__(self, arg=None, **kwargs):
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the plotly.graph_objs.scatterternary.marker.colorbar.Tickformatstops 
constructor must be a dict or 
an instance of :class:`plotly.graph_objs.scatterternary.marker.colorbar.Tickformatstops`"""
            )
