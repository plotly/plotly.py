    ...
    def __init__(
        ...
        **kwargs
        ...
        arg
            ...
            an instance of :py:class:`plotly.graph_objs.scattertern
            ary.marker.Line`
        autocolorscale
            Determines whether the colorscale is a default palette
            (`autocolorscale: true`) or the palette determined by
...
an instance of :py:class:`plotly.graph_objs.scatterternary.marker.Line`"""
            )
...
constructor must be a dict or 
an instance of :py:class:`plotly.graph_objs.scatterternary.marker.Gradient`"""
            )
...
class ColorBar(_BaseTraceHierarchyType):
    ...
    def tickfont(self):
        ...
        that may be specified as:
          - An instance of :py:func:`plotly.graph_objs.scatterternary.marker.colorbar.Tickfont`
    ...
    def tickformatstopdefaults(self):
        ...
        that may be specified as:
          - An instance of :py:func:`plotly.graph_objs.scatterternary.marker.colorbar.Tickformatstop`
          - A dict of string/value properties that will be passed
    ...
    def title(self):
        ...
        that may be specified as:
          - An instance of :py:func:`plotly.graph_objs.scatterternary.marker.colorbar.Title`
          - A dict of string/value properties that will be passed
    ...
    def titlefont(self):
        ...
        that may be specified as:
          - An instance of :py:func:`plotly.graph_objs.scatterternary.marker.colorbar.title.Font`
          - A dict of string/value properties that will be passed
    ...
    def _prop_descriptions(self):
        ...
        tickformat
            ...
            display "09~15~23.46"
        tickformatstops
            A tuple of :py:class:`plotly.graph_objects.scatterterna
            ry.marker.colorbar.Tickformatstop` instances or dicts
...
constructor must be a dict or 
an instance of :py:class:`plotly.graph_objs.scatterternary.marker.ColorBar`"""
            )
