...
an instance of :py:class:`plotly.graph_objs.scatterpolar.marker.colorbar.Title`"""
            )
    ...
    def __init__(
        ...
        **kwargs
        ...
        arg
            dict of properties compatible with this constructor or
            an instance of :py:class:`plotly.graph_objs.scatterpola
            r.marker.colorbar.Tickformatstop`
        dtickrange
            range [*min*, *max*], where "min", "max" - dtick values
            which describe some zoom level, it is possible to omit
            "min" or "max" value by passing "null"
...
constructor must be a dict or 
an instance of :py:class:`plotly.graph_objs.scatterpolar.marker.colorbar.Tickformatstop`"""
            )
...
constructor must be a dict or 
an instance of :py:class:`plotly.graph_objs.scatterpolar.marker.colorbar.Tickfont`"""
            )
