...
class Textfont(_BaseTraceHierarchyType):
    ...
    def __init__(self, arg=None, color=None, **kwargs):
        ...
        arg
            ...
            an instance of :py:class:`plotly.graph_objs.scattergl.u
            nselected.Textfont`
        color
            Sets the text font color of unselected points, applied
            only when a selection exists.
...
an instance of :py:class:`plotly.graph_objs.scattergl.unselected.Textfont`"""
            )
...
constructor must be a dict or 
an instance of :py:class:`plotly.graph_objs.scattergl.unselected.Marker`"""
            )
