...
class StartValidator(_plotly_utils.basevalidators.NumberValidator):
    ...
    def __init__(
        self, plotly_name='start', parent_name='surface.contours.y', **kwargs
    ):
...
class SizeValidator(_plotly_utils.basevalidators.NumberValidator):
    ...
    def __init__(
        self, plotly_name='size', parent_name='surface.contours.y', **kwargs
    ):
...
class ShowValidator(_plotly_utils.basevalidators.BooleanValidator):
    ...
    def __init__(
        self, plotly_name='show', parent_name='surface.contours.y', **kwargs
    ):
...
class EndValidator(_plotly_utils.basevalidators.NumberValidator):
    ...
    def __init__(
        self, plotly_name='end', parent_name='surface.contours.y', **kwargs
    ):
...
class ColorValidator(_plotly_utils.basevalidators.ColorValidator):
    ...
    def __init__(
        self, plotly_name='color', parent_name='surface.contours.y', **kwargs
    ):
