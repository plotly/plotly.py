...
class WidthValidator(_plotly_utils.basevalidators.NumberValidator):
    ...
    def __init__(
        self, plotly_name='width', parent_name='surface.contours.z', **kwargs
    ):
...
class ShowValidator(_plotly_utils.basevalidators.BooleanValidator):
    ...
    def __init__(
        self, plotly_name='show', parent_name='surface.contours.z', **kwargs
    ):
...
class ColorValidator(_plotly_utils.basevalidators.ColorValidator):
    ...
    def __init__(
        self, plotly_name='color', parent_name='surface.contours.z', **kwargs
    ):
