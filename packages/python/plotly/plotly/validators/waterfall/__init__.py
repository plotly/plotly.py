...
class TextinfoValidator(_plotly_utils.basevalidators.FlaglistValidator):
    ...
    def __init__(
        self, plotly_name='textinfo', parent_name='waterfall', **kwargs
    ):
...
class TextangleValidator(_plotly_utils.basevalidators.AngleValidator):
    ...
    def __init__(
        self, plotly_name='textangle', parent_name='waterfall', **kwargs
    ):
...
class MetasrcValidator(_plotly_utils.basevalidators.SrcValidator):
    ...
    def __init__(
        self, plotly_name='metasrc', parent_name='waterfall', **kwargs
    ):
...
class HoverlabelValidator(_plotly_utils.basevalidators.CompoundValidator):
    ...
    def __init__(
        self, plotly_name='hoverlabel', parent_name='waterfall', **kwargs
    ):
...
class HoverinfosrcValidator(_plotly_utils.basevalidators.SrcValidator):
    ...
    def __init__(
        self, plotly_name='hoverinfosrc', parent_name='waterfall', **kwargs
    ):
...
class HoverinfoValidator(_plotly_utils.basevalidators.FlaglistValidator):
    ...
    def __init__(
        self, plotly_name='hoverinfo', parent_name='waterfall', **kwargs
    ):
...
class DecreasingValidator(_plotly_utils.basevalidators.CompoundValidator):
    ...
    def __init__(
        self, plotly_name='decreasing', parent_name='waterfall', **kwargs
    ):
...
class CustomdatasrcValidator(_plotly_utils.basevalidators.SrcValidator):
    ...
    def __init__(
        self, plotly_name='customdatasrc', parent_name='waterfall', **kwargs
    ):
...
class CustomdataValidator(_plotly_utils.basevalidators.DataArrayValidator):
    ...
    def __init__(
        self, plotly_name='customdata', parent_name='waterfall', **kwargs
    ):
...
class ConstraintextValidator(_plotly_utils.basevalidators.EnumeratedValidator):
    ...
    def __init__(
        self, plotly_name='constraintext', parent_name='waterfall', **kwargs
    ):
...
class ConnectorValidator(_plotly_utils.basevalidators.CompoundValidator):
    ...
    def __init__(
        self, plotly_name='connector', parent_name='waterfall', **kwargs
    ):
...
class CliponaxisValidator(_plotly_utils.basevalidators.BooleanValidator):
    ...
    def __init__(
        self, plotly_name='cliponaxis', parent_name='waterfall', **kwargs
    ):
...
class AlignmentgroupValidator(_plotly_utils.basevalidators.StringValidator):
    ...
    def __init__(
        self, plotly_name='alignmentgroup', parent_name='waterfall', **kwargs
    ):
