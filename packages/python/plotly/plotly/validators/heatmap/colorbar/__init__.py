...
class YpadValidator(_plotly_utils.basevalidators.NumberValidator):
    ...
    def __init__(
        self, plotly_name='ypad', parent_name='heatmap.colorbar', **kwargs
    ):
...
class YanchorValidator(_plotly_utils.basevalidators.EnumeratedValidator):
    ...
    def __init__(
        self, plotly_name='yanchor', parent_name='heatmap.colorbar', **kwargs
    ):
...
class YValidator(_plotly_utils.basevalidators.NumberValidator):
    ...
    def __init__(
        self, plotly_name='y', parent_name='heatmap.colorbar', **kwargs
    ):
...
class XpadValidator(_plotly_utils.basevalidators.NumberValidator):
    ...
    def __init__(
        self, plotly_name='xpad', parent_name='heatmap.colorbar', **kwargs
    ):
...
class XanchorValidator(_plotly_utils.basevalidators.EnumeratedValidator):
    ...
    def __init__(
        self, plotly_name='xanchor', parent_name='heatmap.colorbar', **kwargs
    ):
...
class XValidator(_plotly_utils.basevalidators.NumberValidator):
    ...
    def __init__(
        self, plotly_name='x', parent_name='heatmap.colorbar', **kwargs
    ):
...
class TitleValidator(_plotly_utils.basevalidators.TitleValidator):
    ...
    def __init__(
        self, plotly_name='title', parent_name='heatmap.colorbar', **kwargs
    ):
...
class TicksValidator(_plotly_utils.basevalidators.EnumeratedValidator):
    ...
    def __init__(
        self, plotly_name='ticks', parent_name='heatmap.colorbar', **kwargs
    ):
...
class TicklenValidator(_plotly_utils.basevalidators.NumberValidator):
    ...
    def __init__(
        self, plotly_name='ticklen', parent_name='heatmap.colorbar', **kwargs
    ):
...
class Tick0Validator(_plotly_utils.basevalidators.AnyValidator):
    ...
    def __init__(
        self, plotly_name='tick0', parent_name='heatmap.colorbar', **kwargs
    ):
...
class NticksValidator(_plotly_utils.basevalidators.IntegerValidator):
    ...
    def __init__(
        self, plotly_name='nticks', parent_name='heatmap.colorbar', **kwargs
    ):
...
class LenmodeValidator(_plotly_utils.basevalidators.EnumeratedValidator):
    ...
    def __init__(
        self, plotly_name='lenmode', parent_name='heatmap.colorbar', **kwargs
    ):
...
class LenValidator(_plotly_utils.basevalidators.NumberValidator):
    ...
    def __init__(
        self, plotly_name='len', parent_name='heatmap.colorbar', **kwargs
    ):
...
class DtickValidator(_plotly_utils.basevalidators.AnyValidator):
    ...
    def __init__(
        self, plotly_name='dtick', parent_name='heatmap.colorbar', **kwargs
    ):
...
class BgcolorValidator(_plotly_utils.basevalidators.ColorValidator):
    ...
    def __init__(
        self, plotly_name='bgcolor', parent_name='heatmap.colorbar', **kwargs
    ):
