...
class YpadValidator(_plotly_utils.basevalidators.NumberValidator):
    ...
    def __init__(
        self, plotly_name='ypad', parent_name='heatmapgl.colorbar', **kwargs
    ):
...
class YValidator(_plotly_utils.basevalidators.NumberValidator):
    ...
    def __init__(
        self, plotly_name='y', parent_name='heatmapgl.colorbar', **kwargs
    ):
...
class XpadValidator(_plotly_utils.basevalidators.NumberValidator):
    ...
    def __init__(
        self, plotly_name='xpad', parent_name='heatmapgl.colorbar', **kwargs
    ):
...
class XValidator(_plotly_utils.basevalidators.NumberValidator):
    ...
    def __init__(
        self, plotly_name='x', parent_name='heatmapgl.colorbar', **kwargs
    ):
...
class TitleValidator(_plotly_utils.basevalidators.TitleValidator):
    ...
    def __init__(
        self, plotly_name='title', parent_name='heatmapgl.colorbar', **kwargs
    ):
...
class TicksValidator(_plotly_utils.basevalidators.EnumeratedValidator):
    ...
    def __init__(
        self, plotly_name='ticks', parent_name='heatmapgl.colorbar', **kwargs
    ):
...
class Tick0Validator(_plotly_utils.basevalidators.AnyValidator):
    ...
    def __init__(
        self, plotly_name='tick0', parent_name='heatmapgl.colorbar', **kwargs
    ):
...
class LenValidator(_plotly_utils.basevalidators.NumberValidator):
    ...
    def __init__(
        self, plotly_name='len', parent_name='heatmapgl.colorbar', **kwargs
    ):
...
class DtickValidator(_plotly_utils.basevalidators.AnyValidator):
    ...
    def __init__(
        self, plotly_name='dtick', parent_name='heatmapgl.colorbar', **kwargs
    ):
