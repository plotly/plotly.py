...
class WidthValidator(_plotly_utils.basevalidators.NumberValidator):
    ...
    def __init__(
        self, plotly_name='width', parent_name='bar.error_x', **kwargs
    ):
...
class VisibleValidator(_plotly_utils.basevalidators.BooleanValidator):
    ...
    def __init__(
        self, plotly_name='visible', parent_name='bar.error_x', **kwargs
    ):
...
class ValueminusValidator(_plotly_utils.basevalidators.NumberValidator):
    ...
    def __init__(
        self, plotly_name='valueminus', parent_name='bar.error_x', **kwargs
    ):
...
class ValueValidator(_plotly_utils.basevalidators.NumberValidator):
    ...
    def __init__(
        self, plotly_name='value', parent_name='bar.error_x', **kwargs
    ):
...
class TypeValidator(_plotly_utils.basevalidators.EnumeratedValidator):
    ...
    def __init__(
        self, plotly_name='type', parent_name='bar.error_x', **kwargs
    ):
...
class TracerefValidator(_plotly_utils.basevalidators.IntegerValidator):
    ...
    def __init__(
        self, plotly_name='traceref', parent_name='bar.error_x', **kwargs
    ):
...
class ThicknessValidator(_plotly_utils.basevalidators.NumberValidator):
    ...
    def __init__(
        self, plotly_name='thickness', parent_name='bar.error_x', **kwargs
    ):
...
class SymmetricValidator(_plotly_utils.basevalidators.BooleanValidator):
    ...
    def __init__(
        self, plotly_name='symmetric', parent_name='bar.error_x', **kwargs
    ):
...
class ColorValidator(_plotly_utils.basevalidators.ColorValidator):
    ...
    def __init__(
        self, plotly_name='color', parent_name='bar.error_x', **kwargs
    ):
...
class ArrayminusValidator(_plotly_utils.basevalidators.DataArrayValidator):
    ...
    def __init__(
        self, plotly_name='arrayminus', parent_name='bar.error_x', **kwargs
    ):
...
class ArrayValidator(_plotly_utils.basevalidators.DataArrayValidator):
    ...
    def __init__(
        self, plotly_name='array', parent_name='bar.error_x', **kwargs
    ):
