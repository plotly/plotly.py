...
class WidthsrcValidator(_plotly_utils.basevalidators.SrcValidator):
    ...
    def __init__(
        self, plotly_name='widthsrc', parent_name='bar.marker.line', **kwargs
    ):
...
class WidthValidator(_plotly_utils.basevalidators.NumberValidator):
    ...
    def __init__(
        self, plotly_name='width', parent_name='bar.marker.line', **kwargs
    ):
...
class ColorsrcValidator(_plotly_utils.basevalidators.SrcValidator):
    ...
    def __init__(
        self, plotly_name='colorsrc', parent_name='bar.marker.line', **kwargs
    ):
...
class CminValidator(_plotly_utils.basevalidators.NumberValidator):
    ...
    def __init__(
        self, plotly_name='cmin', parent_name='bar.marker.line', **kwargs
    ):
...
class CmidValidator(_plotly_utils.basevalidators.NumberValidator):
    ...
    def __init__(
        self, plotly_name='cmid', parent_name='bar.marker.line', **kwargs
    ):
...
class CmaxValidator(_plotly_utils.basevalidators.NumberValidator):
    ...
    def __init__(
        self, plotly_name='cmax', parent_name='bar.marker.line', **kwargs
    ):
...
class CautoValidator(_plotly_utils.basevalidators.BooleanValidator):
    ...
    def __init__(
        self, plotly_name='cauto', parent_name='bar.marker.line', **kwargs
    ):
