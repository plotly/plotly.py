...
class YpadValidator(_plotly_utils.basevalidators.NumberValidator):
    ...
    def __init__(
        self, plotly_name='ypad', parent_name='streamtube.colorbar', **kwargs
    ):
...
class XpadValidator(_plotly_utils.basevalidators.NumberValidator):
    ...
    def __init__(
        self, plotly_name='xpad', parent_name='streamtube.colorbar', **kwargs
    ):
...
class LenValidator(_plotly_utils.basevalidators.NumberValidator):
    ...
    def __init__(
        self, plotly_name='len', parent_name='streamtube.colorbar', **kwargs
    ):
