...
if sys.version_info < (3, 7) or TYPE_CHECKING:
    ...
    __all__, __getattr__, __dir__ = relative_import(
        __name__,
        [],
        ['._visible.VisibleValidator', '._valuessrc.ValuessrcValidator', '._values.ValuesValidator', '._ticktextsrc.TicktextsrcValidator', '._ticktext.TicktextValidator', '._label.LabelValidator', '._displayindex.DisplayindexValidator', '._categoryorder.CategoryorderValidator', '._categoryarraysrc.CategoryarraysrcValidator', '._categoryarray.CategoryarrayValidator']
    )
