...
class XsrcValidator(_plotly_utils.basevalidators.SrcValidator):
    ...
    def __init__(
        self, plotly_name='xsrc', parent_name='candlestick', **kwargs
    ):
...
class XcalendarValidator(_plotly_utils.basevalidators.EnumeratedValidator):
    ...
    def __init__(
        self, plotly_name='xcalendar', parent_name='candlestick', **kwargs
    ):
...
class XAxisValidator(_plotly_utils.basevalidators.SubplotidValidator):
    ...
    def __init__(
        self, plotly_name='xaxis', parent_name='candlestick', **kwargs
    ):
...
class WhiskerwidthValidator(_plotly_utils.basevalidators.NumberValidator):
    ...
    def __init__(
        self, plotly_name='whiskerwidth', parent_name='candlestick', **kwargs
    ):
...
class VisibleValidator(_plotly_utils.basevalidators.EnumeratedValidator):
    ...
    def __init__(
        self, plotly_name='visible', parent_name='candlestick', **kwargs
    ):
...
class UirevisionValidator(_plotly_utils.basevalidators.AnyValidator):
    ...
    def __init__(
        self, plotly_name='uirevision', parent_name='candlestick', **kwargs
    ):
...
class TextsrcValidator(_plotly_utils.basevalidators.SrcValidator):
    ...
    def __init__(
        self, plotly_name='textsrc', parent_name='candlestick', **kwargs
    ):
...
class TextValidator(_plotly_utils.basevalidators.StringValidator):
    ...
    def __init__(
        self, plotly_name='text', parent_name='candlestick', **kwargs
    ):
...
class StreamValidator(_plotly_utils.basevalidators.CompoundValidator):
    ...
    def __init__(
        self, plotly_name='stream', parent_name='candlestick', **kwargs
    ):
...
class ShowlegendValidator(_plotly_utils.basevalidators.BooleanValidator):
    ...
    def __init__(
        self, plotly_name='showlegend', parent_name='candlestick', **kwargs
    ):
...
class OpensrcValidator(_plotly_utils.basevalidators.SrcValidator):
    ...
    def __init__(
        self, plotly_name='opensrc', parent_name='candlestick', **kwargs
    ):
...
class OpenValidator(_plotly_utils.basevalidators.DataArrayValidator):
    ...
    def __init__(
        self, plotly_name='open', parent_name='candlestick', **kwargs
    ):
...
class OpacityValidator(_plotly_utils.basevalidators.NumberValidator):
    ...
    def __init__(
        self, plotly_name='opacity', parent_name='candlestick', **kwargs
    ):
...
class NameValidator(_plotly_utils.basevalidators.StringValidator):
    ...
    def __init__(
        self, plotly_name='name', parent_name='candlestick', **kwargs
    ):
...
class MetasrcValidator(_plotly_utils.basevalidators.SrcValidator):
    ...
    def __init__(
        self, plotly_name='metasrc', parent_name='candlestick', **kwargs
    ):
...
class MetaValidator(_plotly_utils.basevalidators.AnyValidator):
    ...
    def __init__(
        self, plotly_name='meta', parent_name='candlestick', **kwargs
    ):
...
class LowsrcValidator(_plotly_utils.basevalidators.SrcValidator):
    ...
    def __init__(
        self, plotly_name='lowsrc', parent_name='candlestick', **kwargs
    ):
...
class LineValidator(_plotly_utils.basevalidators.CompoundValidator):
    ...
    def __init__(
        self, plotly_name='line', parent_name='candlestick', **kwargs
    ):
...
class LegendgroupValidator(_plotly_utils.basevalidators.StringValidator):
    ...
    def __init__(
        self, plotly_name='legendgroup', parent_name='candlestick', **kwargs
    ):
...
class IdssrcValidator(_plotly_utils.basevalidators.SrcValidator):
    ...
    def __init__(
        self, plotly_name='idssrc', parent_name='candlestick', **kwargs
    ):
...
class HovertextsrcValidator(_plotly_utils.basevalidators.SrcValidator):
    ...
    def __init__(
        self, plotly_name='hovertextsrc', parent_name='candlestick', **kwargs
    ):
...
class HovertextValidator(_plotly_utils.basevalidators.StringValidator):
    ...
    def __init__(
        self, plotly_name='hovertext', parent_name='candlestick', **kwargs
    ):
...
class HoverlabelValidator(_plotly_utils.basevalidators.CompoundValidator):
    ...
    def __init__(
        self, plotly_name='hoverlabel', parent_name='candlestick', **kwargs
    ):
...
class HoverinfosrcValidator(_plotly_utils.basevalidators.SrcValidator):
    ...
    def __init__(
        self, plotly_name='hoverinfosrc', parent_name='candlestick', **kwargs
    ):
...
class HoverinfoValidator(_plotly_utils.basevalidators.FlaglistValidator):
    ...
    def __init__(
        self, plotly_name='hoverinfo', parent_name='candlestick', **kwargs
    ):
...
class HighValidator(_plotly_utils.basevalidators.DataArrayValidator):
    ...
    def __init__(
        self, plotly_name='high', parent_name='candlestick', **kwargs
    ):
...
class CustomdataValidator(_plotly_utils.basevalidators.DataArrayValidator):
    ...
    def __init__(
        self, plotly_name='customdata', parent_name='candlestick', **kwargs
    ):
...
class ClosesrcValidator(_plotly_utils.basevalidators.SrcValidator):
    ...
    def __init__(
        self, plotly_name='closesrc', parent_name='candlestick', **kwargs
    ):
...
class CloseValidator(_plotly_utils.basevalidators.DataArrayValidator):
    ...
    def __init__(
        self, plotly_name='close', parent_name='candlestick', **kwargs
    ):
