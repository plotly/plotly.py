...
if sys.version_info < (3, 7) or TYPE_CHECKING:
    ...
    __all__, __getattr__, __dir__ = relative_import(
        __name__,
        [],
        ['._zsrc.ZsrcValidator', '._zmin.ZminValidator', '._zmid.ZmidValidator', '._zmax.ZmaxValidator', '._zauto.ZautoValidator', '._z.ZValidator', '._visible.VisibleValidator', '._unselected.UnselectedValidator', '._uirevision.UirevisionValidator', '._uid.UidValidator', '._textsrc.TextsrcValidator', '._text.TextValidator', '._stream.StreamValidator', '._showscale.ShowscaleValidator', '._showlegend.ShowlegendValidator', '._selectedpoints.SelectedpointsValidator', '._selected.SelectedValidator', '._reversescale.ReversescaleValidator', '._name.NameValidator', '._metasrc.MetasrcValidator', '._meta.MetaValidator', '._marker.MarkerValidator', '._locationssrc.LocationssrcValidator', '._locations.LocationsValidator', '._locationmode.LocationmodeValidator', '._legendwidth.LegendwidthValidator', '._legendrank.LegendrankValidator', '._legendgrouptitle.LegendgrouptitleValidator', '._legendgroup.LegendgroupValidator', '._legend.LegendValidator', '._idssrc.IdssrcValidator', '._ids.IdsValidator', '._hovertextsrc.HovertextsrcValidator', '._hovertext.HovertextValidator', '._hovertemplatesrc.HovertemplatesrcValidator', '._hovertemplate.HovertemplateValidator', '._hoverlabel.HoverlabelValidator', '._hoverinfosrc.HoverinfosrcValidator', '._hoverinfo.HoverinfoValidator', '._geojson.GeojsonValidator', '._geo.GeoValidator', '._featureidkey.FeatureidkeyValidator', '._customdatasrc.CustomdatasrcValidator', '._customdata.CustomdataValidator', '._colorscale.ColorscaleValidator', '._colorbar.ColorbarValidator', '._coloraxis.ColoraxisValidator', '._autocolorscale.AutocolorscaleValidator']
    )
