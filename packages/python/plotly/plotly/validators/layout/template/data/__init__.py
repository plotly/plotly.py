...
class ScatterternarysValidator(
    _plotly_utils.basevalidators.CompoundArrayValidator
):
...
class ScatterpolarglsValidator(
    _plotly_utils.basevalidators.CompoundArrayValidator
):
...
class PointcloudsValidator(
    _plotly_utils.basevalidators.CompoundArrayValidator
):

    def __init__(
        self,
        plotly_name='pointcloud',
        parent_name='layout.template.data',
        **kwargs
    ):
...
class Histogram2dContoursValidator(
    _plotly_utils.basevalidators.CompoundArrayValidator
):
