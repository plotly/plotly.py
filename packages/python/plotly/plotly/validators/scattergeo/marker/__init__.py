...
if sys.version_info < (3, 7) or TYPE_CHECKING:
    ...
    __all__, __getattr__, __dir__ = relative_import(
        __name__,
        [],
        ['._symbolsrc.SymbolsrcValidator', '._symbol.SymbolValidator', '._standoffsrc.StandoffsrcValidator', '._standoff.StandoffValidator', '._sizesrc.SizesrcValidator', '._sizeref.SizerefValidator', '._sizemode.SizemodeValidator', '._sizemin.SizeminValidator', '._size.SizeValidator', '._showscale.ShowscaleValidator', '._reversescale.ReversescaleValidator', '._opacitysrc.OpacitysrcValidator', '._opacity.OpacityValidator', '._line.LineValidator', '._gradient.GradientValidator', '._colorsrc.ColorsrcValidator', '._colorscale.ColorscaleValidator', '._colorbar.ColorbarValidator', '._coloraxis.ColoraxisValidator', '._color.ColorValidator', '._cmin.CminValidator', '._cmid.CmidValidator', '._cmax.CmaxValidator', '._cauto.CautoValidator', '._autocolorscale.AutocolorscaleValidator', '._anglesrc.AnglesrcValidator', '._angleref.AnglerefValidator', '._angle.AngleValidator']
    )
