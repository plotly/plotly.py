...
class StartValidator(_plotly_utils.basevalidators.AnyValidator):
    ...
    def __init__(
        self, plotly_name='start', parent_name='histogram.xbins', **kwargs
    ):
...
class SizeValidator(_plotly_utils.basevalidators.AnyValidator):
    ...
    def __init__(
        self, plotly_name='size', parent_name='histogram.xbins', **kwargs
    ):
...
class EndValidator(_plotly_utils.basevalidators.AnyValidator):
    ...
    def __init__(
        self, plotly_name='end', parent_name='histogram.xbins', **kwargs
    ):
