...
class WidthValidator(_plotly_utils.basevalidators.NumberValidator):
    ...
    def __init__(
        self, plotly_name='width', parent_name='funnel.marker.line', **kwargs
    ):
...
class ColorValidator(_plotly_utils.basevalidators.ColorValidator):
    ...
    def __init__(
        self, plotly_name='color', parent_name='funnel.marker.line', **kwargs
    ):
...
class CminValidator(_plotly_utils.basevalidators.NumberValidator):
    ...
    def __init__(
        self, plotly_name='cmin', parent_name='funnel.marker.line', **kwargs
    ):
...
class CmidValidator(_plotly_utils.basevalidators.NumberValidator):
    ...
    def __init__(
        self, plotly_name='cmid', parent_name='funnel.marker.line', **kwargs
    ):
...
class CmaxValidator(_plotly_utils.basevalidators.NumberValidator):
    ...
    def __init__(
        self, plotly_name='cmax', parent_name='funnel.marker.line', **kwargs
    ):
...
class CautoValidator(_plotly_utils.basevalidators.BooleanValidator):
    ...
    def __init__(
        self, plotly_name='cauto', parent_name='funnel.marker.line', **kwargs
    ):
