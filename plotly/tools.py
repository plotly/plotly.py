...
def return_figure_from_figure_or_data(figure_or_data, validate_figure):
    ...
    if isinstance(figure_or_data, dict):
        ...
        raise plotly.exceptions.PlotlyError("The `figure_or_data` positional "
                                     "argument must be "
    ...
    if validate_figure and not validated:
        ...
        try:
            ...
            raise plotly.exceptions.PlotlyError("Invalid 'figure_or_data' argument. "
                                         ...
                                         "".format(err))
        if not figure['data']:
            raise plotly.exceptions.PlotlyEmptyDataError(
