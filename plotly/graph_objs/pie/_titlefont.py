    ...
    def __init__(
        ...
        **kwargs
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the plotly.graph_objs.pie.Titlefont 
...
an instance of plotly.graph_objs.pie.Titlefont"""
        ...
        # Import validators
        # -----------------
        from plotly.validators.pie import (titlefont as v_titlefont)

        # Initialize validators
        # ---------------------
        self._validators['color'] = v_titlefont.ColorValidator()
        self._validators['colorsrc'] = v_titlefont.ColorsrcValidator()
        self._validators['family'] = v_titlefont.FamilyValidator()
        self._validators['familysrc'] = v_titlefont.FamilysrcValidator()
        self._validators['size'] = v_titlefont.SizeValidator()
        self._validators['sizesrc'] = v_titlefont.SizesrcValidator()
