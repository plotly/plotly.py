...
an instance of plotly.graph_objs.layout.XAxis"""
        ...
        self.anchor = anchor if anchor is not None else v
        v = arg.pop('automargin', None)
        self.automargin = automargin if automargin is not None else v
        ...
        v = arg.pop('constrain', None)
        self.constrain = constrain if constrain is not None else v
        v = arg.pop('constraintoward', None)
        self.constraintoward = constraintoward if constraintoward is not None else v
        ...
        self.fixedrange = fixedrange if fixedrange is not None else v
        ...
        v = arg.pop('overlaying', None)
        self.overlaying = overlaying if overlaying is not None else v
        v = arg.pop('position', None)
        self.position = position if position is not None else v
        ...
        v = arg.pop('rangeselector', None)
        self.rangeselector = rangeselector if rangeselector is not None else v
        v = arg.pop('rangeslider', None)
        self.rangeslider = rangeslider if rangeslider is not None else v
        v = arg.pop('scaleanchor', None)
        self.scaleanchor = scaleanchor if scaleanchor is not None else v
        v = arg.pop('scaleratio', None)
        self.scaleratio = scaleratio if scaleratio is not None else v
        ...
        v = arg.pop('spikedash', None)
        self.spikedash = spikedash if spikedash is not None else v
        v = arg.pop('spikemode', None)
        self.spikemode = spikemode if spikemode is not None else v
        v = arg.pop('spikesnap', None)
        self.spikesnap = spikesnap if spikesnap is not None else v
