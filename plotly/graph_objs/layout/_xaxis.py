...
an instance of plotly.graph_objs.layout.XAxis"""
        ...
        self.automargin = automargin or v
        ...
        self.constrain = constrain or v
        v = arg.pop('constraintoward', None)
        self.constraintoward = constraintoward or v
        ...
        self.overlaying = overlaying or v
        v = arg.pop('position', None)
        self.position = position or v
        ...
        self.rangeselector = rangeselector or v
        v = arg.pop('rangeslider', None)
        self.rangeslider = rangeslider or v
        v = arg.pop('scaleanchor', None)
        self.scaleanchor = scaleanchor or v
        v = arg.pop('scaleratio', None)
        self.scaleratio = scaleratio or v
        ...
        self.spikedash = spikedash or v
        v = arg.pop('spikemode', None)
        self.spikemode = spikemode or v
        v = arg.pop('spikesnap', None)
        self.spikesnap = spikesnap or v
