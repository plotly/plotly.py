...
class Data(_BaseLayoutHierarchyType):
    ...
    def __init__(self,
            arg=None,
            barpolar: None|None = None,
            bar: None|None = None,
            box: None|None = None,
            candlestick: None|None = None,
            carpet: None|None = None,
            choroplethmapbox: None|None = None,
            choroplethmap: None|None = None,
            choropleth: None|None = None,
            cone: None|None = None,
            contourcarpet: None|None = None,
            contour: None|None = None,
            densitymapbox: None|None = None,
            densitymap: None|None = None,
            funnelarea: None|None = None,
            funnel: None|None = None,
            heatmap: None|None = None,
            histogram2dcontour: None|None = None,
            histogram2d: None|None = None,
            histogram: None|None = None,
            icicle: None|None = None,
            image: None|None = None,
            indicator: None|None = None,
            isosurface: None|None = None,
            mesh3d: None|None = None,
            ohlc: None|None = None,
            parcats: None|None = None,
            parcoords: None|None = None,
            pie: None|None = None,
            sankey: None|None = None,
            scatter3d: None|None = None,
            scattercarpet: None|None = None,
            scattergeo: None|None = None,
            scattergl: None|None = None,
            scattermapbox: None|None = None,
            scattermap: None|None = None,
            scatterpolargl: None|None = None,
            scatterpolar: None|None = None,
            scatter: None|None = None,
            scattersmith: None|None = None,
            scatterternary: None|None = None,
            splom: None|None = None,
            streamtube: None|None = None,
            sunburst: None|None = None,
            surface: None|None = None,
            table: None|None = None,
            treemap: None|None = None,
            violin: None|None = None,
            volume: None|None = None,
            waterfall: None|None = None,
            **kwargs
        ):
        """
