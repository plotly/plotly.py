...
class Titlefont(BaseLayoutHierarchyType):
    ...
    def __init__(self, arg=None, color=None, family=None, size=None, **kwargs):
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the plotly.graph_objs.layout.xaxis.Titlefont 
...
an instance of plotly.graph_objs.layout.xaxis.Titlefont"""
        ...
        # Import validators
        # -----------------
        from plotly.validators.layout.xaxis import (titlefont as v_titlefont)
