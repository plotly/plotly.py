    ...
    def __init__(
        ...
        **kwargs
        ...
        arg
            ...
            an instance of
            plotly.graph_objs.parcoords.hoverlabel.Font
        color
        ...
        if arg is None:
            ...
            raise ValueError(
                """\
The first argument to the plotly.graph_objs.parcoords.hoverlabel.Font 
constructor must be a dict or 
an instance of plotly.graph_objs.parcoords.hoverlabel.Font"""
            )

        # Import validators
        # -----------------
        from plotly.validators.parcoords.hoverlabel import (font as v_font)
