...
an instance of plotly.graph_objs.Scatterternary"""
        ...
        v = arg.pop('c', None)
        self.c = c if c is not None else v
        ...
        v = arg.pop('csrc', None)
        self.csrc = csrc if csrc is not None else v
        ...
        self.subplot = subplot if subplot is not None else v
        v = arg.pop('sum', None)
        ...
        self._validators['type'] = LiteralValidator(
            plotly_name='type', parent_name='scatterternary'
        )
