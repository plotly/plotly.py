...
an instance of plotly.graph_objs.Splom"""
        ...
        self.diagonal = diagonal if diagonal is not None else v
        ...
        self.showlowerhalf = showlowerhalf if showlowerhalf is not None else v
        v = arg.pop('showupperhalf', None)
        self.showupperhalf = showupperhalf if showupperhalf is not None else v
