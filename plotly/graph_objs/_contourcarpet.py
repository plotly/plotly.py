...
an instance of plotly.graph_objs.Contourcarpet"""
        ...
        v = arg.pop('a0', None)
        self.a0 = a0 if a0 is not None else v
        v = arg.pop('asrc', None)
        self.asrc = asrc if asrc is not None else v
        v = arg.pop('atype', None)
        self.atype = atype if atype is not None else v
        ...
        v = arg.pop('b0', None)
        self.b0 = b0 if b0 is not None else v
        v = arg.pop('bsrc', None)
        self.bsrc = bsrc if bsrc is not None else v
        v = arg.pop('btype', None)
        self.btype = btype if btype is not None else v
        v = arg.pop('carpet', None)
        self.carpet = carpet if carpet is not None else v
        ...
        v = arg.pop('da', None)
        self.da = da if da is not None else v
        v = arg.pop('db', None)
        self.db = db if db is not None else v
