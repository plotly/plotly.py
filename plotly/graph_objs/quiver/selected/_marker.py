...
class Marker(_BaseTraceHierarchyType):
    ...
    _path_str = "quiver.selected.marker"
    ...
    def line(self):
        ...
        that may be specified as:
          - An instance of :class:`plotly.graph_objs.quiver.selected.marker.Line`
          - A dict of string/value properties that will be passed
            to the Line constructor

        Returns
        -------
        plotly.graph_objs.quiver.selected.marker.Line
        """
        return self["line"]
    ...
    def _prop_descriptions(self):
        ...
        color
            Sets the marker color of selected points.
        line
            :class:`plotly.graph_objects.quiver.selected.marker.Lin
    ...
    def __init__(self, arg=None, color=None, line=None, **kwargs):
        ...
        arg
            ...
            an instance of
            :class:`plotly.graph_objs.quiver.selected.Marker`
        color
            Sets the marker color of selected points.
        line
            :class:`plotly.graph_objects.quiver.selected.marker.Lin
        ...
        if arg is None:
            ...
            raise ValueError("""\
The first argument to the plotly.graph_objs.quiver.selected.Marker
