...
class Marker(_BaseTraceHierarchyType):
    ...
    def colorbar(self):
        ...
        Returns
        -------
        plotly.graph_objs.quiver.marker.ColorBar
        """
    ...
    def line(self):
        ...
        that may be specified as:
          - An instance of :class:`plotly.graph_objs.quiver.marker.Line`
          - A dict of string/value properties that will be passed
            to the Line constructor

        Returns
        -------
        plotly.graph_objs.quiver.marker.Line
        """
        return self["line"]
    ...
    def _prop_descriptions(self):
        ...
        colorbar
            :class:`plotly.graph_objects.quiver.marker.ColorBar`
        ...
        line
            :class:`plotly.graph_objects.quiver.marker.Line`
            instance or dict with compatible properties
        reversescale
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if arg is None:
            ...
            raise ValueError("""\
The first argument to the plotly.graph_objs.quiver.Marker
