...
class Marker(_BaseTraceHierarchyType):
    _parent_path_str = "quiver.unselected"
    _path_str = "quiver.unselected.marker"
    ...
    def line(self):
        ...
        that may be specified as:
          - An instance of :class:`plotly.graph_objs.quiver.unselected.marker.Line`
          - A dict of string/value properties that will be passed
            to the Line constructor

        Returns
        -------
        plotly.graph_objs.quiver.unselected.marker.Line
        """
        return self["line"]
    ...
    def _prop_descriptions(self):
        ...
        line
            :class:`plotly.graph_objects.quiver.unselected.marker.L
    ...
    def __init__(self, arg=None, color=None, line=None, **kwargs):
        ...
        arg
            ...
            an instance of
            :class:`plotly.graph_objs.quiver.unselected.Marker`
        color
            Sets the marker color of unselected points, applied
            only when a selection exists.
        line
        ...
        if arg is None:
            ...
            raise ValueError("""\
The first argument to the plotly.graph_objs.quiver.unselected.Marker
