...
class Textfont(_BaseTraceHierarchyType):
    ...
    _path_str = "quiver.unselected.textfont"
    _valid_props = {"color"}
    ...
    def __init__(self, arg=None, color=None, **kwargs):
        ...
        arg
            ...
            an instance of
            :class:`plotly.graph_objs.quiver.unselected.Textfont`
        color
            Sets the text font color of unselected points, applied
            only when a selection exists.
        ...
        if arg is None:
            ...
            raise ValueError("""\
The first argument to the plotly.graph_objs.quiver.unselected.Textfont
