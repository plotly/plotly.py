...
class Font(_BaseTraceHierarchyType):
    _parent_path_str = "quiver.legendgrouptitle"
    _path_str = "quiver.legendgrouptitle.font"
    _valid_props = {
        "color",
        "family",
        "lineposition",
    ...
    def __init__(
        ...
        **kwargs,
        ...
        arg
            ...
            an instance of
            :class:`plotly.graph_objs.quiver.legendgrouptitle.Font`
        color
        ...
        if arg is None:
            ...
            raise ValueError("""\
The first argument to the plotly.graph_objs.quiver.legendgrouptitle.Font
