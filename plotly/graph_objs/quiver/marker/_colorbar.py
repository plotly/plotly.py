...
class ColorBar(_BaseTraceHierarchyType):
    _parent_path_str = "quiver.marker"
    _path_str = "quiver.marker.colorbar"
    _valid_props = {
        "bgcolor",
        "bordercolor",
        "borderwidth",
    ...
    def tickfont(self):
        ...
        that may be specified as:
          - An instance of :class:`plotly.graph_objs.quiver.marker.colorbar.Tickfont`
          - A dict of string/value properties that will be passed
            to the Tickfont constructor

        Returns
        -------
        plotly.graph_objs.quiver.marker.colorbar.Tickfont
        """
    ...
    def tickformatstops(self):
        ...
        Tickformatstop that may be specified as:
          - A list or tuple of instances of plotly.graph_objs.quiver.marker.colorbar.Tickformatstop
          - A list or tuple of dicts of string/value properties that
            will be passed to the Tickformatstop constructor

        Returns
        -------
        tuple[plotly.graph_objs.quiver.marker.colorbar.Tickformatstop]
        """
    ...
    def tickformatstopdefaults(self):
        """
        When used in a template (as layout.template.data.quiver.marker.
        ...
        that may be specified as:
          - An instance of :class:`plotly.graph_objs.quiver.marker.colorbar.Tickformatstop`
          - A dict of string/value properties that will be passed
            to the Tickformatstop constructor

        Returns
        -------
        plotly.graph_objs.quiver.marker.colorbar.Tickformatstop
        """
    ...
    def title(self):
        ...
        that may be specified as:
          - An instance of :class:`plotly.graph_objs.quiver.marker.colorbar.Title`
          - A dict of string/value properties that will be passed
            to the Title constructor

        Returns
        -------
        plotly.graph_objs.quiver.marker.colorbar.Title
        """
        return self["title"]
    ...
    def _prop_descriptions(self):
        ...
        tickformat
            ...
            display "09~15~23.46"
        tickformatstops
            A tuple of :class:`plotly.graph_objects.quiver.marker.c
            olorbar.Tickformatstop` instances or dicts with
            compatible properties
        tickformatstopdefaults
            When used in a template (as layout.template.data.quiver
        ...
        tickwidth
            Sets the tick width (in px).
        title
            :class:`plotly.graph_objects.quiver.marker.colorbar.Tit
    ...
    def __init__(
        ...
        **kwargs,
        ...
        arg
            ...
            an instance of
            :class:`plotly.graph_objs.quiver.marker.ColorBar`
        bgcolor
            Sets the color of padded area.
        bordercolor
            Sets the axis line color.
        ...
        if arg is None:
            ...
            raise ValueError("""\
The first argument to the plotly.graph_objs.quiver.marker.ColorBar
constructor must be a dict or
an instance of :class:`plotly.graph_objs.quiver.marker.ColorBar`""")
