...
class Font(_BaseTraceHierarchyType):
    _parent_path_str = "quiver.marker.colorbar.title"
    _path_str = "quiver.marker.colorbar.title.font"
    _valid_props = {
        "color",
        "family",
        "lineposition",
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if arg is None:
            ...
            raise ValueError("""\
The first argument to the plotly.graph_objs.quiver.marker.colorbar.title.Font
