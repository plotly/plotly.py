...
an instance of plotly.graph_objs.Box"""
        ...
        self.boxmean = boxmean if boxmean is not None else v
        v = arg.pop('boxpoints', None)
        self.boxpoints = boxpoints if boxpoints is not None else v
        ...
        self.notched = notched if notched is not None else v
        v = arg.pop('notchwidth', None)
        self.notchwidth = notchwidth if notchwidth is not None else v
