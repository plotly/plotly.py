          ...
          - A dict of string/value properties that will be passed
            ...
            Supported dict properties:
                ...
                autocolorscale
                    ...
                    determined by `line.colorscale`. In case
                ...
                cmax
                    ...
                    `line.color` array index, and if set,
                ...
                showscale
                    Has an effect only if `line.color` is set to a
                    numerical array. Determines whether or not a
...
an instance of plotly.graph_objs.Scatter3d"""
        ...
        self.error_z = error_z if error_z is not None else v
        ...
        v = arg.pop('mode', None)
        self.mode = mode if mode is not None else v
        v = arg.pop('name', None)
        ...
        self.surfaceaxis = surfaceaxis if surfaceaxis is not None else v
        v = arg.pop('surfacecolor', None)
        self.surfacecolor = surfacecolor if surfacecolor is not None else v
        v = arg.pop('text', None)
