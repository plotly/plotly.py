...
an instance of plotly.graph_objs.Scatterpolar"""
        ...
        self.theta = theta if theta is not None else v
        v = arg.pop('thetasrc', None)
        self.thetasrc = thetasrc if thetasrc is not None else v
        v = arg.pop('thetaunit', None)
        self.thetaunit = thetaunit if thetaunit is not None else v
        v = arg.pop('uid', None)
        ...
        self._validators['type'] = LiteralValidator(
            plotly_name='type', parent_name='scatterpolar'
        )
