        ...
        expected = Figure({
            'data': [
                ...
                {'dimensions': [{'values': ['A', 'A', 'B', 'A', 'B']},
                                {'values': ['a', 'a', 'a', 'b', 'b']}],
                 'domain': {'x': [0.0, 0.94], 'y': [0.0, 0.19375]},
                 'type': 'parcats'}],
            'layout': {
                'geo': {'domain': {'x': [0.52, 0.94],
                                   'y': [0.26875, 0.4625]}},
                'height': 1200,
                'polar': {'domain': {'x': [0.0, 0.42],
                                     'y': [0.5375, 0.73125]}},
                'scene': {'domain': {'x': [0.0, 0.42],
                                     'y': [0.26875, 0.4625]}},
                'ternary': {'domain': {'x': [0.52, 0.94],
                                       'y': [0.5375, 0.73125]}},
                'xaxis': {'anchor': 'y', 'domain': [0.0, 0.42]},
                'xaxis2': {'anchor': 'y2', 'domain': [0.52, 0.94]},
