...
class TestSparkline(NumpyTestUtilsMixin, TestCase):
    ...
    def test_is_colors_a_list(self):
        ...
        message = 'colors must be a list/tuple'
        self.assertRaisesRegexp(PlotlyError, message, ff.create_sparkline,
                                df, colors='not going to work')

    def test_colors_correct_length(self):
        df = pd.DataFrame(
            [
                [5, 2, 9],
                [6, 5, 4],
        ...
        message = 'colors must be a list/tuple with 2 colors inside'
        self.assertRaisesRegexp(PlotlyError, message, ff.create_sparkline,
                                df, colors=['rgb(0, 0, 0)'])
    ...
    def test_full_sparkline_fig(self):
        ...
        fig = ff.create_sparkline(
            df, chart_types=('name', 'bullet', 'line', 'avg', 'bar'),
        ...
        'data': [{'fill': 'tozeroy',
           'hoverinfo': 'none',
           'line': {'color': 'rgba(255, 253, 250, 0.5)', 'width': 0},
           'mode': 'line',
           'type': 'scatter',
           'x': [0, 1],
           'xaxis': 'x1',
          ...
          {'fill': 'tozeroy',
           'hoverinfo': 'none',
           'line': {'color': 'rgba(249, 247, 244, 0.5)', 'width': 0},
           'mode': 'line',
           'type': 'scatter',
           'x': [0, 1],
           'xaxis': 'x6',
          ...
          {'marker': {'color': ['rgb(181,221,232)',
           ...
           'y': [9, 4, 6],
           'yaxis': 'y15'}],
         'layout': {'annotations': [{'font': {'size': 15},
            'showarrow': False,
            'text': 'foo',
            'x': 0.5,
            'xanchor': 'center',
          ...
          'title': 'this is a test',
          'xaxis1': {'anchor': 'y1',
           'domain': [0.0, 0.058666666666666666],
           'range': [0, 1],
           'showgrid': False,
           'showticklabels': False,
           'zeroline': False},
          ...
          'xaxis11': {'anchor': 'y11',
           ...
           'zeroline': False},
          'xaxis12': {'anchor': 'y12',
           'domain': [0.08866666666666667, 0.20600000000000002],
           'showgrid': False,
           'showticklabels': False,
           'zeroline': False},
          'xaxis13': {'anchor': 'y13',
           'domain': [0.236, 0.41200000000000003],
           'showgrid': False,
           'showticklabels': False,
           'zeroline': False},
          'xaxis14': {'anchor': 'y14',
           'domain': [0.44199999999999995, 0.6766666666666666],
           'range': [0, 1],
           'showgrid': False,
           'showticklabels': False,
           'zeroline': False},
        ...
        #self.assert_dict_equal(fig['data'], exp_fig['data'])
