    ...
    def test_full_bullet(self):
        ...
        exp_fig = {
            ...
            'layout': {'annotations': [{'font': {'color': '#0f0f0f', 'size': 13},
                       ...
                       'height': 600,
                       'margin': {'l': 80},
                       'shapes': [{'fillcolor': 'rgb(255.0, 127.0, 14.0)',
                                   'layer': 'below',
                                   'line': {'width': 0},
                                   'opacity': 1,
                                   'type': 'rect',
                                   ...
                                   'y1': 150,
                                   'yref': 'y1'},
                                  {'fillcolor': 'rgb(149.5, 143.5, 29.0)',
                                   'layer': 'below',
                                   'line': {'width': 0},
                                   'opacity': 1,
                                   'type': 'rect',
                       ...
                       'xaxis2': {'anchor': 'y2',
                                  ...
                                  'zeroline': False},
                       'xaxis3': {'anchor': 'y3',
                                  'domain': [0.406, 0.5940000000000001],
                                  'range': [0, 1],
                                  'showgrid': False,
                                  'showticklabels': False,
                                  'zeroline': False},
                       'xaxis4': {'anchor': 'y4',
                                  'domain': [0.609, 0.7969999999999999],
                                  'range': [0, 1],
                                  'showgrid': False,
                                  'showticklabels': False,
                                  'zeroline': False},
