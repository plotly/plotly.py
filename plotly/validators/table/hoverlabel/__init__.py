...
class FontValidator(_plotly_utils.basevalidators.CompoundValidator):
    ...
    def __init__(
        self, plotly_name='font', parent_name='table.hoverlabel', **kwargs
    ):
...
class BgcolorValidator(_plotly_utils.basevalidators.ColorValidator):
    ...
    def __init__(
        self, plotly_name='bgcolor', parent_name='table.hoverlabel', **kwargs
    ):
...
class AlignValidator(_plotly_utils.basevalidators.EnumeratedValidator):
    ...
    def __init__(
        self, plotly_name='align', parent_name='table.hoverlabel', **kwargs
    ):
