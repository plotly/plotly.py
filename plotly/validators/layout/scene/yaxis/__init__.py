...
class TypeValidator(_plotly_utils.basevalidators.EnumeratedValidator):
    ...
    def __init__(
        self, plotly_name='type', parent_name='layout.scene.yaxis', **kwargs
    ):
...
class TicksValidator(_plotly_utils.basevalidators.EnumeratedValidator):
    ...
    def __init__(
        self, plotly_name='ticks', parent_name='layout.scene.yaxis', **kwargs
    ):
...
class Tick0Validator(_plotly_utils.basevalidators.AnyValidator):
    ...
    def __init__(
        self, plotly_name='tick0', parent_name='layout.scene.yaxis', **kwargs
    ):
...
class DtickValidator(_plotly_utils.basevalidators.AnyValidator):
    ...
    def __init__(
        self, plotly_name='dtick', parent_name='layout.scene.yaxis', **kwargs
    ):
...
class ColorValidator(_plotly_utils.basevalidators.ColorValidator):
    ...
    def __init__(
        self, plotly_name='color', parent_name='layout.scene.yaxis', **kwargs
    ):
