...
class YValidator(_plotly_utils.basevalidators.InfoArrayValidator):
    ...
    def __init__(
        self, plotly_name='y', parent_name='layout.scene.domain', **kwargs
    ):
...
class XValidator(_plotly_utils.basevalidators.InfoArrayValidator):
    ...
    def __init__(
        self, plotly_name='x', parent_name='layout.scene.domain', **kwargs
    ):
...
class RowValidator(_plotly_utils.basevalidators.IntegerValidator):
    ...
    def __init__(
        self, plotly_name='row', parent_name='layout.scene.domain', **kwargs
    ):
