...
class SplitValidator(_plotly_utils.basevalidators.BooleanValidator):
    ...
    def __init__(
        self, plotly_name='split', parent_name='ohlc.hoverlabel', **kwargs
    ):
...
class FontValidator(_plotly_utils.basevalidators.CompoundValidator):
    ...
    def __init__(
        self, plotly_name='font', parent_name='ohlc.hoverlabel', **kwargs
    ):
...
class BgcolorValidator(_plotly_utils.basevalidators.ColorValidator):
    ...
    def __init__(
        self, plotly_name='bgcolor', parent_name='ohlc.hoverlabel', **kwargs
    ):
...
class AlignsrcValidator(_plotly_utils.basevalidators.SrcValidator):
    ...
    def __init__(
        self, plotly_name='alignsrc', parent_name='ohlc.hoverlabel', **kwargs
    ):
...
class AlignValidator(_plotly_utils.basevalidators.EnumeratedValidator):
    ...
    def __init__(
        self, plotly_name='align', parent_name='ohlc.hoverlabel', **kwargs
    ):
