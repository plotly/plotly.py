...
class YValidator(_plotly_utils.basevalidators.InfoArrayValidator):
    ...
    def __init__(
        self, plotly_name='y', parent_name='sunburst.domain', **kwargs
    ):
...
class XValidator(_plotly_utils.basevalidators.InfoArrayValidator):
    ...
    def __init__(
        self, plotly_name='x', parent_name='sunburst.domain', **kwargs
    ):
...
class RowValidator(_plotly_utils.basevalidators.IntegerValidator):
    ...
    def __init__(
        self, plotly_name='row', parent_name='sunburst.domain', **kwargs
    ):
...
class ColumnValidator(_plotly_utils.basevalidators.IntegerValidator):
    ...
    def __init__(
        self, plotly_name='column', parent_name='sunburst.domain', **kwargs
    ):
