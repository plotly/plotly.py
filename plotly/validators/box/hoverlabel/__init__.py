...
class BgcolorValidator(_plotly_utils.basevalidators.ColorValidator):
    ...
    def __init__(
        self, plotly_name='bgcolor', parent_name='box.hoverlabel', **kwargs
    ):
...
class AlignsrcValidator(_plotly_utils.basevalidators.SrcValidator):
    ...
    def __init__(
        self, plotly_name='alignsrc', parent_name='box.hoverlabel', **kwargs
    ):
...
class AlignValidator(_plotly_utils.basevalidators.EnumeratedValidator):
    ...
    def __init__(
        self, plotly_name='align', parent_name='box.hoverlabel', **kwargs
    ):
