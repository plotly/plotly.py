...
class SelectedpointsValidator(_plotly_utils.basevalidators.AnyValidator):
    ...
    def __init__(
        self, plotly_name='selectedpoints', parent_name='box', **kwargs
    ):
...
class HovertextsrcValidator(_plotly_utils.basevalidators.SrcValidator):
    ...
    def __init__(
        self, plotly_name='hovertextsrc', parent_name='box', **kwargs
    ):
...
class HovertemplatesrcValidator(_plotly_utils.basevalidators.SrcValidator):
    ...
    def __init__(
        self, plotly_name='hovertemplatesrc', parent_name='box', **kwargs
    ):
...
class HovertemplateValidator(_plotly_utils.basevalidators.StringValidator):
    ...
    def __init__(
        self, plotly_name='hovertemplate', parent_name='box', **kwargs
    ):
...
class CustomdatasrcValidator(_plotly_utils.basevalidators.SrcValidator):
    ...
    def __init__(
        self, plotly_name='customdatasrc', parent_name='box', **kwargs
    ):
...
class AlignmentgroupValidator(_plotly_utils.basevalidators.StringValidator):
    ...
    def __init__(
        self, plotly_name='alignmentgroup', parent_name='box', **kwargs
    ):
