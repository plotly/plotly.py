...
class YpadValidator(_plotly_utils.basevalidators.NumberValidator):
    ...
    def __init__(
        self, plotly_name='ypad', parent_name='choropleth.colorbar', **kwargs
    ):
...
class YValidator(_plotly_utils.basevalidators.NumberValidator):
    ...
    def __init__(
        self, plotly_name='y', parent_name='choropleth.colorbar', **kwargs
    ):
...
class XpadValidator(_plotly_utils.basevalidators.NumberValidator):
    ...
    def __init__(
        self, plotly_name='xpad', parent_name='choropleth.colorbar', **kwargs
    ):
...
class XValidator(_plotly_utils.basevalidators.NumberValidator):
    ...
    def __init__(
        self, plotly_name='x', parent_name='choropleth.colorbar', **kwargs
    ):
...
class LenValidator(_plotly_utils.basevalidators.NumberValidator):
    ...
    def __init__(
        self, plotly_name='len', parent_name='choropleth.colorbar', **kwargs
    ):
