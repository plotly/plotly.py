...
class ColorBar(_BaseTraceHierarchyType):
    ...
    def tickfont(self):
        ...
        - An instance of :class:`plotly.graph_objects.parcoords.line.colorbar.Tickfont`
    ...
    def tickformatstops(self):
        ...
        Tickformatstop that may be specified as:
          - A list or tuple of instances of plotly.graph_objects.parcoords.line.colorbar.Tickformatstop
          - A list or tuple of dicts of string/value properties that
            will be passed to the Tickformatstop constructor

        Returns
        -------
        tuple[plotly.graph_objects.parcoords.line.colorbar.Tickformatstop]
        """
    ...
    def tickformatstopdefaults(self):
        ...
        - An instance of :class:`plotly.graph_objects.parcoords.line.colorbar.Tickformatstop`
    ...
    def title(self):
        ...
        - An instance of :class:`plotly.graph_objects.parcoords.line.colorbar.Title`
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if arg is None:
            ...
            raise ValueError("""\
The first argument to the plotly.graph_objects.parcoords.line.ColorBar
constructor must be a dict or
an instance of :class:`plotly.graph_objects.parcoords.line.ColorBar`""")
