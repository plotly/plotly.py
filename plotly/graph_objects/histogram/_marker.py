...
class Marker(_BaseTraceHierarchyType):
    ...
    def line(self):
        ...
        - An instance of :class:`plotly.graph_objects.histogram.marker.Line`
    ...
    def pattern(self):
        ...
        - An instance of :class:`plotly.graph_objects.histogram.marker.Pattern`
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if arg is None:
            ...
            raise ValueError("""\
The first argument to the plotly.graph_objects.histogram.Marker
