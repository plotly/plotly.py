...
class Line(_BaseTraceHierarchyType):
    ...
    def color(self):
        ...
        - A number that will be interpreted as a color according to scattergeo.marker.line.colorscale
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if arg is None:
            ...
            raise ValueError("""\
The first argument to the plotly.graph_objects.scattergeo.marker.Line
