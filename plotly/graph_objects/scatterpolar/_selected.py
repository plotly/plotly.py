...
class Selected(_BaseTraceHierarchyType):
    ...
    def marker(self):
        ...
        - An instance of :class:`plotly.graph_objects.scatterpolar.selected.Marker`
    ...
    def textfont(self):
        ...
        - An instance of :class:`plotly.graph_objects.scatterpolar.selected.Textfont`
    ...
    def __init__(self, arg=None, marker=None, textfont=None, **kwargs):
        ...
        if arg is None:
            ...
            raise ValueError("""\
The first argument to the plotly.graph_objects.scatterpolar.Selected
