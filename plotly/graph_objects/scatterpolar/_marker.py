...
class Marker(_BaseTraceHierarchyType):
    ...
    def color(self):
        ...
        - A number that will be interpreted as a color according to scatterpolar.marker.colorscale
    ...
    def colorbar(self):
        ...
        - An instance of :class:`plotly.graph_objects.scatterpolar.marker.ColorBar`
    ...
    def gradient(self):
        ...
        - An instance of :class:`plotly.graph_objects.scatterpolar.marker.Gradient`
    ...
    def line(self):
        ...
        - An instance of :class:`plotly.graph_objects.scatterpolar.marker.Line`
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if arg is None:
            ...
            raise ValueError("""\
The first argument to the plotly.graph_objects.scatterpolar.Marker
constructor must be a dict or
an instance of :class:`plotly.graph_objects.scatterpolar.Marker`""")
