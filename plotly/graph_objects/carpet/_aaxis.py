...
class Aaxis(_BaseTraceHierarchyType):
    ...
    def tickfont(self):
        ...
        - An instance of :class:`plotly.graph_objects.carpet.aaxis.Tickfont`
        - A dict of string/value properties that will be passed to the Tickfont constructor

        Returns
        -------
        plotly.graph_objects.carpet.aaxis.Tickfont
        """
    ...
    def tickformatstops(self):
        ...
        Returns
        -------
        tuple[plotly.graph_objects.carpet.aaxis.Tickformatstop]
        """
    ...
    def tickformatstopdefaults(self):
        ...
        - An instance of :class:`plotly.graph_objects.carpet.aaxis.Tickformatstop`
    ...
    def title(self):
        ...
        - An instance of :class:`plotly.graph_objects.carpet.aaxis.Title`
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if arg is None:
            ...
            raise ValueError("""\
The first argument to the plotly.graph_objects.carpet.Aaxis
