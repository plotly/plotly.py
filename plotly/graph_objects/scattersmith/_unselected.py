...
class Unselected(_BaseTraceHierarchyType):
    ...
    def marker(self):
        ...
        - An instance of :class:`plotly.graph_objects.scattersmith.unselected.Marker`
    ...
    def textfont(self):
        ...
        - An instance of :class:`plotly.graph_objects.scattersmith.unselected.Textfont`
    ...
    def __init__(self, arg=None, marker=None, textfont=None, **kwargs):
        ...
        if arg is None:
            ...
            raise ValueError("""\
The first argument to the plotly.graph_objects.scattersmith.Unselected
