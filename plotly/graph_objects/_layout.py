...
class Layout(_BaseLayoutType):
    ...
    def template(self):
        ...
        applied cyclically to traces of each type. Container arrays (eg
    ...
    def _prop_descriptions(self):
        ...
        template
            ...
            plotly.graph_objects.layout.Template.  Trace templates
            are applied cyclically to traces of each type.
            Container arrays (eg `annotations`) have special
            ...
            referenced is appended to the end of the array, so this
            can be used to add a watermark annotation or a logo
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if arg is None:
            ...
            raise ValueError("""\
The first argument to the plotly.graph_objects.Layout
