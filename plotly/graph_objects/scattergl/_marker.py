...
class Marker(_BaseTraceHierarchyType):
    ...
    def colorbar(self):
        ...
        - An instance of :class:`plotly.graph_objects.scattergl.marker.ColorBar`
    ...
    def line(self):
        ...
        - An instance of :class:`plotly.graph_objects.scattergl.marker.Line`
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if arg is None:
            ...
            raise ValueError("""\
The first argument to the plotly.graph_objects.scattergl.Marker
