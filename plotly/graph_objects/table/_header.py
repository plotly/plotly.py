...
class Header(_BaseTraceHierarchyType):
    ...
    def fill(self):
        ...
        that may be specified as:
          - An instance of :class:`plotly.graph_objects.table.header.Fill`
    ...
    def font(self):
        ...
        that may be specified as:
          - An instance of :class:`plotly.graph_objects.table.header.Font`
          - A dict of string/value properties that will be passed
    ...
    def line(self):
        ...
        that may be specified as:
          - An instance of :class:`plotly.graph_objects.table.header.Line`
          - A dict of string/value properties that will be passed
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if arg is None:
            ...
            raise ValueError("""\
The first argument to the plotly.graph_objects.table.Header
