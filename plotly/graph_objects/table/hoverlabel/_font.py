    ...
    def __init__(
        ...
        **kwargs,
        ...
        arg
            ...
            an instance of
            :class:`plotly.graph_objects.table.hoverlabel.Font`
        color
        ...
        if arg is None:
            ...
            raise ValueError("""\
The first argument to the plotly.graph_objects.table.hoverlabel.Font
constructor must be a dict or
an instance of :class:`plotly.graph_objects.table.hoverlabel.Font`""")
