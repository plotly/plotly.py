...
class Marker(_BaseTraceHierarchyType):
    ...
    def line(self):
        ...
        - An instance of :class:`plotly.graph_objects.funnelarea.marker.Line`
    ...
    def pattern(self):
        ...
        - An instance of :class:`plotly.graph_objects.funnelarea.marker.Pattern`
    ...
    def __init__(
        ...
        if arg is None:
            ...
            raise ValueError("""\
The first argument to the plotly.graph_objects.funnelarea.Marker
