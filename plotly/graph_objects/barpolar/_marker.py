...
class Marker(_BaseTraceHierarchyType):
    ...
    def color(self):
        ...
        - A number that will be interpreted as a color according to barpolar.marker.colorscale
    ...
    def line(self):
        ...
        - An instance of :class:`plotly.graph_objects.barpolar.marker.Line`
    ...
    def pattern(self):
        ...
        - An instance of :class:`plotly.graph_objects.barpolar.marker.Pattern`
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if arg is None:
            ...
            raise ValueError("""\
The first argument to the plotly.graph_objects.barpolar.Marker
