...
class ColorBar(_BaseTraceHierarchyType):
    ...
    def tickfont(self):
        ...
        - An instance of :class:`plotly.graph_objects.histogram2dcontour.colorbar.Tickfont`
    ...
    def tickformatstopdefaults(self):
        ...
        - An instance of :class:`plotly.graph_objects.histogram2dcontour.colorbar.Tickformatstop`
    ...
    def title(self):
        ...
        - An instance of :class:`plotly.graph_objects.histogram2dcontour.colorbar.Title`
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if arg is None:
            ...
            raise ValueError("""\
The first argument to the plotly.graph_objects.histogram2dcontour.ColorBar
