...
class Bar(_BaseTraceHierarchyType):
    ...
    def line(self):
        ...
        that may be specified as:
          - An instance of :class:`plotly.graph_objects.indicator.gauge.bar.Line`
    ...
    def __init__(self, arg=None, color=None, line=None, thickness=None, **kwargs):
        ...
        arg
            ...
            an instance of
            :class:`plotly.graph_objects.indicator.gauge.Bar`
        color
            Sets the background color of the arc.
        line
            :class:`plotly.graph_objects.indicator.gauge.bar.Line`
        ...
        if arg is None:
            ...
            raise ValueError("""\
The first argument to the plotly.graph_objects.indicator.gauge.Bar
