...
class Axis(_BaseTraceHierarchyType):
    ...
    def tickfont(self):
        ...
        that may be specified as:
          - An instance of :class:`plotly.graph_objects.indicator.gauge.axis.Tickfont`
    ...
    def tickformatstops(self):
        ...
        Returns
        -------
        tuple[plotly.graph_objects.indicator.gauge.axis.Tickformatstop]
        """
    ...
    def tickformatstopdefaults(self):
        ...
        that may be specified as:
          - An instance of :class:`plotly.graph_objects.indicator.gauge.axis.Tickformatstop`
          - A dict of string/value properties that will be passed
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if arg is None:
            ...
            raise ValueError("""\
The first argument to the plotly.graph_objects.indicator.gauge.Axis
