...
class Hoverlabel(_BaseTraceHierarchyType):
    ...
    def font(self):
        ...
        that may be specified as:
          - An instance of :class:`plotly.graph_objects.sankey.node.hoverlabel.Font`
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if arg is None:
            ...
            raise ValueError("""\
The first argument to the plotly.graph_objects.sankey.node.Hoverlabel
constructor must be a dict or
an instance of :class:`plotly.graph_objects.sankey.node.Hoverlabel`""")
