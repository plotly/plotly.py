...
class Heatmap(_BaseTraceType):
    ...
    def hoverlabel(self):
        ...
        that may be specified as:
          - An instance of :class:`plotly.graph_objects.heatmap.Hoverlabel`
          - A dict of string/value properties that will be passed
    ...
    def legendgrouptitle(self):
        ...
        that may be specified as:
          - An instance of :class:`plotly.graph_objects.heatmap.Legendgrouptitle`
          - A dict of string/value properties that will be passed
    ...
    def stream(self):
        ...
        that may be specified as:
          - An instance of :class:`plotly.graph_objects.heatmap.Stream`
          - A dict of string/value properties that will be passed
    ...
    def textfont(self):
        ...
        that may be specified as:
          - An instance of :class:`plotly.graph_objects.heatmap.Textfont`
          - A dict of string/value properties that will be passed
    ...
    def __init__(
        ...
        **kwargs,
        ...
        arg
            ...
            an instance of :class:`plotly.graph_objects.Heatmap`
        autocolorscale
            Determines whether the colorscale is a default palette
            (`autocolorscale: true`) or the palette determined by
            `colorscale`. In case `colorscale` is unspecified or
        ...
        if arg is None:
            ...
            raise ValueError("""\
The first argument to the plotly.graph_objects.Heatmap
