...
class Marker(_BaseTraceHierarchyType):
    ...
    def colorbar(self):
        ...
        - An instance of :class:`plotly.graph_objects.scatter.marker.ColorBar`
    ...
    def gradient(self):
        ...
        - An instance of :class:`plotly.graph_objects.scatter.marker.Gradient`
    ...
    def line(self):
        ...
        - An instance of :class:`plotly.graph_objects.scatter.marker.Line`
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if arg is None:
            ...
            raise ValueError("""\
The first argument to the plotly.graph_objects.scatter.Marker
