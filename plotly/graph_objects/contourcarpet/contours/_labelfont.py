    ...
    def __init__(
        ...
        **kwargs,
        ...
        if arg is None:
            ...
            raise ValueError("""\
The first argument to the plotly.graph_objects.contourcarpet.contours.Labelfont
constructor must be a dict or
an instance of :class:`plotly.graph_objects.contourcarpet.contours.Labelfont`""")
