...
class Marker(_BaseTraceHierarchyType):
    ...
    def __init__(self, arg=None, color=None, opacity=None, size=None, **kwargs):
        ...
        if arg is None:
            ...
            raise ValueError("""\
The first argument to the plotly.graph_objects.scattermapbox.unselected.Marker
constructor must be a dict or
an instance of :class:`plotly.graph_objects.scattermapbox.unselected.Marker`""")
