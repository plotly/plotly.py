    ...
    def __init__(
        ...
        **kwargs,
        ...
        arg
            ...
            an instance of
            :class:`plotly.graph_objects.treemap.pathbar.Textfont`
        color
        ...
        if arg is None:
            ...
            raise ValueError("""\
The first argument to the plotly.graph_objects.treemap.pathbar.Textfont
constructor must be a dict or
an instance of :class:`plotly.graph_objects.treemap.pathbar.Textfont`""")
