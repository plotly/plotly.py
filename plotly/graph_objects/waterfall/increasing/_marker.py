...
class Marker(_BaseTraceHierarchyType):
    ...
    def line(self):
        ...
        that may be specified as:
          - An instance of :class:`plotly.graph_objects.waterfall.increasing.marker.Line`
    ...
    def __init__(self, arg=None, color=None, line=None, **kwargs):
        ...
        arg
            ...
            an instance of :class:`plotly.graph_objects.waterfall.i
            ncreasing.Marker`
        color
            Sets the marker color of all increasing values.
        line
        ...
        if arg is None:
            ...
            raise ValueError("""\
The first argument to the plotly.graph_objects.waterfall.increasing.Marker
constructor must be a dict or
an instance of :class:`plotly.graph_objects.waterfall.increasing.Marker`""")
