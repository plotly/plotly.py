...
class Line(_BaseTraceHierarchyType):
    ...
    def __init__(self, arg=None, color=None, width=None, **kwargs):
        ...
        arg
            ...
            an instance of :class:`plotly.graph_objects.waterfall.d
            ecreasing.marker.Line`
        color
            Sets the line color of all decreasing values.
        width
            Sets the line width of all decreasing values.
        ...
        if arg is None:
            ...
            raise ValueError("""\
The first argument to the plotly.graph_objects.waterfall.decreasing.marker.Line
constructor must be a dict or
an instance of :class:`plotly.graph_objects.waterfall.decreasing.marker.Line`""")
