...
class Marker(_BaseTraceHierarchyType):
    ...
    def line(self):
        ...
        - An instance of :class:`plotly.graph_objects.waterfall.totals.marker.Line`
    ...
    def __init__(self, arg=None, color=None, line=None, **kwargs):
        ...
        if arg is None:
            ...
            raise ValueError("""\
The first argument to the plotly.graph_objects.waterfall.totals.Marker
constructor must be a dict or
an instance of :class:`plotly.graph_objects.waterfall.totals.Marker`""")
