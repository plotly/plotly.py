...
class Marker(_BaseTraceHierarchyType):
    ...
    def colorbar(self):
        ...
        Returns
        -------
        plotly.graph_objects.icicle.marker.ColorBar
        """
    ...
    def line(self):
        ...
        that may be specified as:
          - An instance of :class:`plotly.graph_objects.icicle.marker.Line`
          - A dict of string/value properties that will be passed
            to the Line constructor

        Returns
        -------
        plotly.graph_objects.icicle.marker.Line
        """
        return self["line"]
    ...
    def pattern(self):
        ...
        that may be specified as:
          - An instance of :class:`plotly.graph_objects.icicle.marker.Pattern`
          - A dict of string/value properties that will be passed
            to the Pattern constructor

        Returns
        -------
        plotly.graph_objects.icicle.marker.Pattern
        """
        return self["pattern"]
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if arg is None:
            ...
            raise ValueError("""\
The first argument to the plotly.graph_objects.icicle.Marker
