...
class Unselected(_BaseTraceHierarchyType):
    ...
    def marker(self):
        ...
        that may be specified as:
          - An instance of :class:`plotly.graph_objects.scatterternary.unselected.Marker`
    ...
    def textfont(self):
        ...
        that may be specified as:
          - An instance of :class:`plotly.graph_objects.scatterternary.unselected.Textfont`
          - A dict of string/value properties that will be passed
    ...
    def __init__(self, arg=None, marker=None, textfont=None, **kwargs):
        ...
        if arg is None:
            ...
            raise ValueError("""\
The first argument to the plotly.graph_objects.scatterternary.Unselected
