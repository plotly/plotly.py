...
class Project(_BaseTraceHierarchyType):
    ...
    def __init__(self, arg=None, x=None, y=None, z=None, **kwargs):
        ...
        arg
            ...
            an instance of :class:`plotly.graph_objects.surface.con
            tours.z.Project`
        x
            Determines whether or not these contour lines are
            projected on the x plane. If `highlight` is set to True
        ...
        if arg is None:
            ...
            raise ValueError("""\
The first argument to the plotly.graph_objects.surface.contours.z.Project
constructor must be a dict or
an instance of :class:`plotly.graph_objects.surface.contours.z.Project`""")
