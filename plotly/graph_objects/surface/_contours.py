...
class Contours(_BaseTraceHierarchyType):
    ...
    def x(self):
        ...
        - An instance of :class:`plotly.graph_objects.surface.contours.X`
    ...
    def y(self):
        ...
        - An instance of :class:`plotly.graph_objects.surface.contours.Y`
    ...
    def z(self):
        ...
        - An instance of :class:`plotly.graph_objects.surface.contours.Z`
    ...
    def __init__(self, arg=None, x=None, y=None, z=None, **kwargs):
        ...
        if arg is None:
            ...
            raise ValueError("""\
The first argument to the plotly.graph_objects.surface.Contours
