...
class Slices(_BaseTraceHierarchyType):
    ...
    def x(self):
        ...
        - An instance of :class:`plotly.graph_objects.volume.slices.X`
    ...
    def y(self):
        ...
        - An instance of :class:`plotly.graph_objects.volume.slices.Y`
    ...
    def z(self):
        ...
        - An instance of :class:`plotly.graph_objects.volume.slices.Z`
    ...
    def __init__(self, arg=None, x=None, y=None, z=None, **kwargs):
        ...
        if arg is None:
            ...
            raise ValueError("""\
The first argument to the plotly.graph_objects.volume.Slices
