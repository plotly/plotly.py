...
class Unselected(_BaseTraceHierarchyType):
    ...
    def marker(self):
        ...
        - An instance of :class:`plotly.graph_objects.choroplethmapbox.unselected.Marker`
    ...
    def __init__(self, arg=None, marker=None, **kwargs):
        ...
        if arg is None:
            ...
            raise ValueError("""\
The first argument to the plotly.graph_objects.choroplethmapbox.Unselected
