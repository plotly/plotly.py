...
class ColorBar(_BaseTraceHierarchyType):
    ...
    def tickformatstops(self):
        ...
        - A list or tuple of instances of plotly.graph_objects.choroplethmapbox.colorbar.Tickformatstop
        - A list or tuple of dicts of string/value properties that
            will be passed to the Tickformatstop constructor

        Returns
        -------
        tuple[plotly.graph_objects.choroplethmapbox.colorbar.Tickformatstop]
        """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if arg is None:
            ...
            raise ValueError("""\
The first argument to the plotly.graph_objects.choroplethmapbox.ColorBar
