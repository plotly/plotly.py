...
class ColorBar(_BaseTraceHierarchyType):
    ...
    def tickfont(self):
        ...
        that may be specified as:
          - An instance of :class:`plotly.graph_objects.scattermap.marker.colorbar.Tickfont`
    ...
    def tickformatstops(self):
        ...
        Tickformatstop that may be specified as:
          - A list or tuple of instances of plotly.graph_objects.scattermap.marker.colorbar.Tickformatstop
          - A list or tuple of dicts of string/value properties that
            will be passed to the Tickformatstop constructor

        Returns
        -------
        tuple[plotly.graph_objects.scattermap.marker.colorbar.Tickformatstop]
        """
    ...
    def tickformatstopdefaults(self):
        ...
        that may be specified as:
          - An instance of :class:`plotly.graph_objects.scattermap.marker.colorbar.Tickformatstop`
          - A dict of string/value properties that will be passed
    ...
    def title(self):
        ...
        that may be specified as:
          - An instance of :class:`plotly.graph_objects.scattermap.marker.colorbar.Title`
          - A dict of string/value properties that will be passed
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if arg is None:
            ...
            raise ValueError("""\
The first argument to the plotly.graph_objects.scattermap.marker.ColorBar
