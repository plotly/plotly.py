...
class Rangeselector(_BaseLayoutHierarchyType):
    ...
    def buttondefaults(self):
        ...
        - An instance of :class:`plotly.graph_objects.layout.xaxis.rangeselector.Button`
    ...
    def font(self):
        ...
        - An instance of :class:`plotly.graph_objects.layout.xaxis.rangeselector.Font`
    ...
    def __init__(
        ...
        **kwargs,
        ...
        arg
            ...
            an instance of :class:`plotly.graph_objects.layout.xaxi
            s.Rangeselector`
        activecolor
            Sets the background color of the active range selector
            button.
        ...
        if arg is None:
            ...
            raise ValueError("""\
The first argument to the plotly.graph_objects.layout.xaxis.Rangeselector
