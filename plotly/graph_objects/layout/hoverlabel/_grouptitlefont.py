    ...
    def __init__(
        ...
        **kwargs,
        ...
        arg
            ...
            an instance of :class:`plotly.graph_objects.layout.hove
            rlabel.Grouptitlefont`
        color
        ...
        if arg is None:
            ...
            raise ValueError("""\
The first argument to the plotly.graph_objects.layout.hoverlabel.Grouptitlefont
constructor must be a dict or
an instance of :class:`plotly.graph_objects.layout.hoverlabel.Grouptitlefont`""")
