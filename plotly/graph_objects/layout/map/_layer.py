...
class Layer(_BaseLayoutHierarchyType):
    ...
    def circle(self):
        ...
        - An instance of :class:`plotly.graph_objects.layout.map.layer.Circle`
    ...
    def fill(self):
        ...
        - An instance of :class:`plotly.graph_objects.layout.map.layer.Fill`
    ...
    def line(self):
        ...
        - An instance of :class:`plotly.graph_objects.layout.map.layer.Line`
    ...
    def symbol(self):
        ...
        - An instance of :class:`plotly.graph_objects.layout.map.layer.Symbol`
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if arg is None:
            ...
            raise ValueError("""\
The first argument to the plotly.graph_objects.layout.map.Layer
