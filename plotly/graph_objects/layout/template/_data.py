...
class Data(_BaseLayoutHierarchyType):
    ...
    def densitymap(self):
        ...
        Returns
        -------
        tuple[plotly.graph_objects.layout.template.data.Densitymap]
        """
    ...
    def scattermap(self):
        ...
        Returns
        -------
        tuple[plotly.graph_objects.layout.template.data.Scattermap]
        """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if arg is None:
            ...
            raise ValueError("""\
The first argument to the plotly.graph_objects.layout.template.Data
