    ...
    def __init__(
        ...
        **kwargs,
        ...
        arg
            ...
            an instance of :class:`plotly.graph_objects.layout.mapb
            ox.layer.symbol.Textfont`
        color
        ...
        if arg is None:
            ...
            raise ValueError("""\
The first argument to the plotly.graph_objects.layout.mapbox.layer.symbol.Textfont
constructor must be a dict or
an instance of :class:`plotly.graph_objects.layout.mapbox.layer.symbol.Textfont`""")
