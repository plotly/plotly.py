...
class Shape(_BaseLayoutHierarchyType):
    ...
    def label(self):
        ...
        that may be specified as:
          - An instance of :class:`plotly.graph_objects.layout.shape.Label`
    ...
    def line(self):
        ...
        that may be specified as:
          - An instance of :class:`plotly.graph_objects.layout.shape.Line`
          - A dict of string/value properties that will be passed
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if arg is None:
            ...
            raise ValueError("""\
The first argument to the plotly.graph_objects.layout.Shape
