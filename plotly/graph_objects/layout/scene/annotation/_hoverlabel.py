...
class Hoverlabel(_BaseLayoutHierarchyType):
    ...
    def font(self):
        ...
        - An instance of :class:`plotly.graph_objects.layout.scene.annotation.hoverlabel.Font`
    ...
    def __init__(self, arg=None, bgcolor=None, bordercolor=None, font=None, **kwargs):
        ...
        arg
            ...
            an instance of :class:`plotly.graph_objects.layout.scen
        ...
        if arg is None:
            ...
            raise ValueError("""\
The first argument to the plotly.graph_objects.layout.scene.annotation.Hoverlabel
constructor must be a dict or
an instance of :class:`plotly.graph_objects.layout.scene.annotation.Hoverlabel`""")
