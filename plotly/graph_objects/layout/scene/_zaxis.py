...
class ZAxis(_BaseLayoutHierarchyType):
    ...
    def autorangeoptions(self):
        ...
        - An instance of :class:`plotly.graph_objects.layout.scene.zaxis.Autorangeoptions`
    ...
    def tickfont(self):
        ...
        - An instance of :class:`plotly.graph_objects.layout.scene.zaxis.Tickfont`
    ...
    def tickformatstopdefaults(self):
        ...
        - An instance of :class:`plotly.graph_objects.layout.scene.zaxis.Tickformatstop`
    ...
    def title(self):
        ...
        - An instance of :class:`plotly.graph_objects.layout.scene.zaxis.Title`
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if arg is None:
            ...
            raise ValueError("""\
The first argument to the plotly.graph_objects.layout.scene.ZAxis
