...
class XAxis(_BaseLayoutHierarchyType):
    ...
    def autorangeoptions(self):
        ...
        - An instance of :class:`plotly.graph_objects.layout.scene.xaxis.Autorangeoptions`
    ...
    def tickfont(self):
        ...
        - An instance of :class:`plotly.graph_objects.layout.scene.xaxis.Tickfont`
    ...
    def tickformatstopdefaults(self):
        ...
        - An instance of :class:`plotly.graph_objects.layout.scene.xaxis.Tickformatstop`
    ...
    def title(self):
        ...
        - An instance of :class:`plotly.graph_objects.layout.scene.xaxis.Title`
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if arg is None:
            ...
            raise ValueError("""\
The first argument to the plotly.graph_objects.layout.scene.XAxis
