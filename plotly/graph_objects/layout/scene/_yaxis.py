...
class YAxis(_BaseLayoutHierarchyType):
    ...
    def autorangeoptions(self):
        ...
        - An instance of :class:`plotly.graph_objects.layout.scene.yaxis.Autorangeoptions`
    ...
    def tickfont(self):
        ...
        - An instance of :class:`plotly.graph_objects.layout.scene.yaxis.Tickfont`
    ...
    def tickformatstopdefaults(self):
        ...
        - An instance of :class:`plotly.graph_objects.layout.scene.yaxis.Tickformatstop`
    ...
    def title(self):
        ...
        - An instance of :class:`plotly.graph_objects.layout.scene.yaxis.Title`
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if arg is None:
            ...
            raise ValueError("""\
The first argument to the plotly.graph_objects.layout.scene.YAxis
