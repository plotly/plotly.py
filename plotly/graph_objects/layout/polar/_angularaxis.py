...
class AngularAxis(_BaseLayoutHierarchyType):
    ...
    def tickfont(self):
        ...
        - An instance of :class:`plotly.graph_objects.layout.polar.angularaxis.Tickfont`
    ...
    def tickformatstops(self):
        ...
        - A list or tuple of instances of plotly.graph_objects.layout.polar.angularaxis.Tickformatstop
        - A list or tuple of dicts of string/value properties that
            will be passed to the Tickformatstop constructor

        Returns
        -------
        tuple[plotly.graph_objects.layout.polar.angularaxis.Tickformatstop]
        """
    ...
    def tickformatstopdefaults(self):
        ...
        - An instance of :class:`plotly.graph_objects.layout.polar.angularaxis.Tickformatstop`
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if arg is None:
            ...
            raise ValueError("""\
The first argument to the plotly.graph_objects.layout.polar.AngularAxis
