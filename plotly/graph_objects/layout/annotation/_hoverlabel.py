...
class Hoverlabel(_BaseLayoutHierarchyType):
    ...
    def font(self):
        ...
        - An instance of :class:`plotly.graph_objects.layout.annotation.hoverlabel.Font`
    ...
    def __init__(self, arg=None, bgcolor=None, bordercolor=None, font=None, **kwargs):
        ...
        arg
            ...
            an instance of :class:`plotly.graph_objects.layout.anno
            tation.Hoverlabel`
        bgcolor
            Sets the background color of the hover label. By
            default uses the annotation's `bgcolor` made opaque, or
        ...
        if arg is None:
            ...
            raise ValueError("""\
The first argument to the plotly.graph_objects.layout.annotation.Hoverlabel
constructor must be a dict or
an instance of :class:`plotly.graph_objects.layout.annotation.Hoverlabel`""")
