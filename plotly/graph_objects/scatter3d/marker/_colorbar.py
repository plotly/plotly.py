...
class ColorBar(_BaseTraceHierarchyType):
    ...
    def tickfont(self):
        ...
        - An instance of :class:`plotly.graph_objects.scatter3d.marker.colorbar.Tickfont`
    ...
    def tickformatstops(self):
        ...
        - A list or tuple of instances of plotly.graph_objects.scatter3d.marker.colorbar.Tickformatstop
        - A list or tuple of dicts of string/value properties that
            will be passed to the Tickformatstop constructor

        Returns
        -------
        tuple[plotly.graph_objects.scatter3d.marker.colorbar.Tickformatstop]
        """
    ...
    def tickformatstopdefaults(self):
        ...
        - An instance of :class:`plotly.graph_objects.scatter3d.marker.colorbar.Tickformatstop`
    ...
    def title(self):
        ...
        - An instance of :class:`plotly.graph_objects.scatter3d.marker.colorbar.Title`
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if arg is None:
            ...
            raise ValueError("""\
The first argument to the plotly.graph_objects.scatter3d.marker.ColorBar
constructor must be a dict or
an instance of :class:`plotly.graph_objects.scatter3d.marker.ColorBar`""")
