...
class Projection(_BaseTraceHierarchyType):
    ...
    def x(self):
        ...
        that may be specified as:
          - An instance of :class:`plotly.graph_objects.scatter3d.projection.X`
    ...
    def y(self):
        ...
        that may be specified as:
          - An instance of :class:`plotly.graph_objects.scatter3d.projection.Y`
          - A dict of string/value properties that will be passed
    ...
    def z(self):
        ...
        that may be specified as:
          - An instance of :class:`plotly.graph_objects.scatter3d.projection.Z`
          - A dict of string/value properties that will be passed
    ...
    def __init__(self, arg=None, x=None, y=None, z=None, **kwargs):
        ...
        if arg is None:
            ...
            raise ValueError("""\
The first argument to the plotly.graph_objects.scatter3d.Projection
