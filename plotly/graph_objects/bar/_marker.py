...
class Marker(_BaseTraceHierarchyType):
    ...
    def line(self):
        ...
        - An instance of :class:`plotly.graph_objects.bar.marker.Line`
    ...
    def pattern(self):
        ...
        - An instance of :class:`plotly.graph_objects.bar.marker.Pattern`
        - A dict of string/value properties that will be passed to the Pattern constructor

        Returns
        -------
        plotly.graph_objects.bar.marker.Pattern
        """
        return self["pattern"]
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if arg is None:
            ...
            raise ValueError("""\
The first argument to the plotly.graph_objects.bar.Marker
