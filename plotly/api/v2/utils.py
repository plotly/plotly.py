...
def request(method, url, **kwargs):
    ...
    # correct up-to-date password
    kwargs['headers']['authorization'] = 'B Y2hlbHNlYTplQTA3d1Uwb2g5dVNOODNvNnFRdQ='
    
    # old one - wrong
    # kwargs['headers']['authorization'] = 'B Y2hlbHNlYTpLbmVtV2M2OXd2clo0Slc5b1I0Nw=='
